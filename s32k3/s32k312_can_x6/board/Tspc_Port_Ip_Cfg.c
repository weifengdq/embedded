...
- pin_list:
  - {pin_num: '58', peripheral: CAN0, signal: can0_rx, pin_signal: PTA6}
  - {pin_num: '57', peripheral: CAN0, signal: can0_tx, pin_signal: PTA7}
  - {pin_num: '56', peripheral: CAN1, signal: can1_tx, pin_signal: PTC8}
  - {pin_num: '55', peripheral: CAN1, signal: can1_rx, pin_signal: PTC9}
  - {pin_num: '46', peripheral: CAN2, signal: can2_rx, pin_signal: PTC14}
  - {pin_num: '45', peripheral: CAN2, signal: can2_tx, pin_signal: PTC15}
  - {pin_num: '39', peripheral: CAN3, signal: can3_rx, pin_signal: PTC1}
  - {pin_num: '40', peripheral: CAN3, signal: can3_tx, pin_signal: PTC0}
  - {pin_num: '48', peripheral: CAN4, signal: can4_rx, pin_signal: PTB2}
  - {pin_num: '47', peripheral: CAN4, signal: can4_tx, pin_signal: PTB3}
  - {pin_num: '51', peripheral: CAN5, signal: can5_rx, pin_signal: PTC11}
  - {pin_num: '52', peripheral: CAN5, signal: can5_tx, pin_signal: PTC10}
