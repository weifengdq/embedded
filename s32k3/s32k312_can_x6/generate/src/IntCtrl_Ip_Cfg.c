...
static const IntCtrl_Ip_IrqConfigType aIrqConfiguration1[] = {
    ...
    {FlexCAN2_0_IRQn, (boolean)TRUE, 0U, &CAN2_ORED_IRQHandler},
    {FlexCAN2_1_IRQn, (boolean)TRUE, 0U, &CAN2_ORED_0_31_MB_IRQHandler},
    {FlexCAN3_0_IRQn, (boolean)TRUE, 0U, &CAN3_ORED_IRQHandler},
    {FlexCAN3_1_IRQn, (boolean)TRUE, 0U, &CAN3_ORED_0_31_MB_IRQHandler},
    {FlexCAN4_0_IRQn, (boolean)TRUE, 0U, &CAN4_ORED_IRQHandler},
    {FlexCAN4_1_IRQn, (boolean)TRUE, 0U, &CAN4_ORED_0_31_MB_IRQHandler},
    {FlexCAN5_0_IRQn, (boolean)TRUE, 0U, &CAN5_ORED_IRQHandler},
    {FlexCAN5_1_IRQn, (boolean)TRUE, 0U, &CAN5_ORED_0_31_MB_IRQHandler},
};
