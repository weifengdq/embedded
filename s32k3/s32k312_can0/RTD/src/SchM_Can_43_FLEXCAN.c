...
#define SCHM_CAN_43_FLEXCAN_SW_MAJOR_VERSION_C             6
...
void SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_23(void)
{
    uint32 msr;
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();
...
void SchM_Exit_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_23(void)
{
    uint32 u32CoreId = (uint32)OsIf_GetCoreID();
