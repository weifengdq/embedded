...
- pin_list:
  - {pin_num: '129', peripheral: SIUL2, signal: 'gpio, 42', pin_signal: PTB10, direction: OUTPUT}
  - {pin_num: '50', peripheral: LPUART0, signal: lpuart0_rx, pin_signal: PTC2}
  - {pin_num: '49', peripheral: LPUART0, signal: lpuart0_tx, pin_signal: PTC3, direction: OUTPUT}
