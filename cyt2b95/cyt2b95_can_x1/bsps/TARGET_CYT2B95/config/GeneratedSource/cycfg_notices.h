...
#if !defined(CYT2B95CAE)
#error "Unexpected MPN; expected DEVICE:=CYT2B95CAE. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif /* !defined(CYT2B95CAE) */
