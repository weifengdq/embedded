...
#define USER_PHY_STS1_SLPFAIL                      ((uint16_t)0x8000U)
#define USER_PHY_STS1_TDD                          ((uint16_t)0x4000U)
#define USER_PHY_STS1_LNKSTSC                      ((uint16_t)0x2000U)
...
#define USER_PHY_STS1_HDDD                         ((uint16_t)0x0020U)
#define USER_PHY_STS1_PLCADIAG                     ((uint16_t)0x0010U)
