...
#define ISR_PRIORITY_ASCLIN4_TX     31                          /* ASCLIN4 TX — high-speed, 921600 needs low latency */
#define ISR_PRIORITY_ASCLIN4_RX     32                          /* ASCLIN4 RX — highest among UART, above TX & tick   */
