...
/* GCC IFX_INTERRUPT needs single-token numeric literals for the priority
 * argument (GAS altmacro %(expr) only handles bare numbers, not arithmetic).
 * Pre-computed: CAN_PRIORITY=110, CAN_NUM=12
 *   RX[0-11] = 110-121,  TX[0-11] = 122-133,  BusOff[0-11] = 134-145  */
CAN_RX_ISR(0,  0, 110);   CAN_TX_ISR(0,  0, 122);   CAN_BUSOFF_ISR(0,  0, 134);
CAN_RX_ISR(1,  0, 111);   CAN_TX_ISR(1,  0, 123);   CAN_BUSOFF_ISR(1,  0, 135);
CAN_RX_ISR(2,  0, 112);   CAN_TX_ISR(2,  0, 124);   CAN_BUSOFF_ISR(2,  0, 136);
CAN_RX_ISR(3,  0, 113);   CAN_TX_ISR(3,  0, 125);   CAN_BUSOFF_ISR(3,  0, 137);
CAN_RX_ISR(4,  0, 114);   CAN_TX_ISR(4,  0, 126);   CAN_BUSOFF_ISR(4,  0, 138);
CAN_RX_ISR(5,  0, 115);   CAN_TX_ISR(5,  0, 127);   CAN_BUSOFF_ISR(5,  0, 139);
CAN_RX_ISR(6,  0, 116);   CAN_TX_ISR(6,  0, 128);   CAN_BUSOFF_ISR(6,  0, 140);
CAN_RX_ISR(7,  0, 117);   CAN_TX_ISR(7,  0, 129);   CAN_BUSOFF_ISR(7,  0, 141);
CAN_RX_ISR(8,  0, 118);   CAN_TX_ISR(8,  0, 130);   CAN_BUSOFF_ISR(8,  0, 142);
CAN_RX_ISR(9,  0, 119);   CAN_TX_ISR(9,  0, 131);   CAN_BUSOFF_ISR(9,  0, 143);
CAN_RX_ISR(10, 0, 120);   CAN_TX_ISR(10, 0, 132);   CAN_BUSOFF_ISR(10, 0, 144);
CAN_RX_ISR(11, 0, 121);   CAN_TX_ISR(11, 0, 133);   CAN_BUSOFF_ISR(11, 0, 145);
