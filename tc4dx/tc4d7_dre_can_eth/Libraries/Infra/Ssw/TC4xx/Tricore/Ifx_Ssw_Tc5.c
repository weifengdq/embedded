...
*******************************************************************************/
IFX_SSW_USED IFX_SSW_NOINLINE void Ifx_Ssw_disableVirtualization_Cpu5(void);
...
void __Core5_start(void)
{
    ...
    IFX_CFG_SSW_SKIP_STARTUP_ROUTINE(5);
        ...
        IfxSswProt_setState((Ifx_PROT_PROT *)&(MODULE_CPU5.PROTSFRE), IfxSswProt_State_config);
    #endif
    /* Load Base Address of Trap Vector Table. */
    Ifx_Ssw_MTCR(CPU_BTV, (unsigned int)__TRAPTAB(5));
    #if (IFX_PROT_ENABLED == 1U)
        IfxSswProt_setState((Ifx_PROT_PROT *)&(MODULE_CPU5.PROTSFRE), IfxSswProt_State_run);
    #endif

    Ifx_Ssw_MTCR(CPU_FCX, IFX_CFG_SSW_CSA_PTR((unsigned int)__CSA(5)));

    Ifx_Ssw_disableVirtualization_Cpu5();
...
#pragma GCC optimize ("O0")
#endif
void Ifx_Ssw_disableVirtualization_Cpu5(void)
{
...
IFX_SSW_USED void _START5(void)
{
    Ifx_Ssw_Start(__USTACK5, __Core5_start);
}
