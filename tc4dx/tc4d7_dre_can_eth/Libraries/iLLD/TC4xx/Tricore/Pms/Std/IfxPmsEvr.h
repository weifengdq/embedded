...
#define IFXPMSEVR_SARHVLSB_MV   (4.741f)
#else
...
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
#define IFXPMSEVR_TRKHVLSB_MV   (22.64f)
#else
...
typedef enum
{
    ...
    IfxPmsEvr_SecondaryMonitorVoltageSource_vddflex   = 16, /**< \brief Flexport Supply */
...
#if IFXPMS_IS_POWER_DOMAIN_STATUS_REGISTSER0_AVAILABLE
    IfxPmsEvr_StatusRegister_powerdomain   = 8,  /**< \brief Power domain Status Register 0 */
#endif /* #if IFXPMS_IS_POWER_DOMAIN_STATUS_REGISTSER0_AVAILABLE */
...
IFX_INLINE void IfxPmsEvr_setOverVoltageMonitoringMode(Ifx_PMS *pms, IfxPmsEvr_OverVoltageMonitoring mode, IfxPmsEvr_SecondaryMonitorVoltageSource supply)
{
    ...
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddflex:
        pms->VMONS.VDDFLEXCON.B.OVMOD = mode;
        break;
#endif	/* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDFLEX */	
    ...
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddp3nvm:
        pms->VMONS.VDDP3NVMCON.B.OVMOD = mode;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddexths:
        pms->VMONS.VDDEXTHSCON.B.OVMOD = mode;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vdd3pms:
        pms->VMONS.VDD3PMSCON.B.OVMOD = mode;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif0:
        pms->VMONS.VDDRIF0CON.B.OVMOD = mode;
        break;
#endif /* IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif0:
        pms->VMONS.VDDPHRIF0CON.B.OVMOD = mode;
        break;
#endif /* IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif1:
        pms->VMONS.VDDPHRIF1CON.B.OVMOD = mode;
        break;
#endif /* IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF2
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif2:
        pms->VMONS.VDDPHRIF2CON.B.OVMOD = mode;
        break;
#endif /* IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF2 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif1:
        pms->VMONS.VDDRIF1CON.B.OVMOD = mode;
        break;
#endif /* IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif2:
        pms->VMONS.VDDRIF2CON.B.OVMOD = mode;
        break;
#endif /* IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDSB
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddsb:
        pms->VMONS.VDDSBCON.B.OVMOD = mode;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDSB */		
    default:
...
#endif
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
    pms->EVRC.CON0.B.SDVOUTSEL = (uint16)(outputVoltage / IFXPMSEVR_SARMVLSB_MV);
#else
...
IFX_INLINE void IfxPmsEvr_setSecondaryOverVoltageThresholdMv(Ifx_PMS *pms, float32 inputVoltage, IfxPmsEvr_SecondaryMonitorVoltageSource supply)
{
    ...
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphphy1:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        pms->VMONS.VDDPHPHY1CON.B.OVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARMVLSB_MV);
#else
    ...
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddhsif:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        pms->VMONS.VDDHSIFCON.B.OVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARMVLSB_MV);
#else
...
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDFLEX		
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddflex:
        pms->VMONS.VDDFLEXCON.B.OVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDFLEX */
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddpms0:
    ...
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddp3nvm:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        pms->VMONS.VDDP3NVMCON.B.OVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARMVLSB_MV);
#else
        pms->VMONS.VDDP3NVMCON.B.OVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARHVLSB_MV);
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741 */
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS		
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddexths:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        pms->VMONS.VDDEXTHSCON.B.OVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARHVLSB_MV);
#else
        pms->VMONS.VDDEXTHSCON.B.OVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARHVLSB_MV);
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741 */
        break;
    ...
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vdd3pms:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        pms->VMONS.VDD3PMSCON.B.OVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARMVLSB_MV);
#else
        pms->VMONS.VDD3PMSCON.B.OVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARHVLSB_MV);
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741 */
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif0:
        pms->VMONS.VDDRIF0CON.B.OVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARCORELSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif0:
        pms->VMONS.VDDPHRIF0CON.B.OVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif1:
        pms->VMONS.VDDPHRIF1CON.B.OVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF2
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif2:
        pms->VMONS.VDDPHRIF2CON.B.OVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF2 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif1:
        pms->VMONS.VDDRIF1CON.B.OVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARCORELSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif2:
        pms->VMONS.VDDRIF2CON.B.OVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARCORELSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDSB
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddsb:
        pms->VMONS.VDDSBCON.B.OVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDSB */	
    default:
        /* Invalid Supply selected */
...
IFX_INLINE void IfxPmsEvr_setSecondaryUnderVoltageThresholdMv(Ifx_PMS *pms, float32 inputVoltage, IfxPmsEvr_SecondaryMonitorVoltageSource supply)
{
    ...
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphphy1:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        pms->VMONS.VDDPHPHY1CON.B.UVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARMVLSB_MV);
#else
    ...
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddhsif:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        pms->VMONS.VDDHSIFCON.B.UVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARMVLSB_MV);
#else
...
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDFLEX		
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddflex:
        pms->VMONS.VDDFLEXCON.B.UVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDFLEX */		
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddpms0:
    ...
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddp3nvm:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        pms->VMONS.VDDP3NVMCON.B.UVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARMVLSB_MV);
#else
        pms->VMONS.VDDP3NVMCON.B.UVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARHVLSB_MV);
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741  */
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS		
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddexths:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        pms->VMONS.VDDEXTHSCON.B.UVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARHVLSB_MV);
#else
        pms->VMONS.VDDEXTHSCON.B.UVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARHVLSB_MV);
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741  */ 
        break;
    ...
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vdd3pms:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        pms->VMONS.VDD3PMSCON.B.UVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARMVLSB_MV);
#else
        pms->VMONS.VDD3PMSCON.B.UVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARHVLSB_MV);
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741 */ 
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif0:
        pms->VMONS.VDDRIF0CON.B.UVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARCORELSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif0:
        pms->VMONS.VDDPHRIF0CON.B.UVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif1:
        pms->VMONS.VDDPHRIF1CON.B.UVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF2
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif2:
        pms->VMONS.VDDPHRIF2CON.B.UVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF2 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF2
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif1:
        pms->VMONS.VDDRIF1CON.B.UVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARCORELSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF2 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif2:
        pms->VMONS.VDDRIF2CON.B.UVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARCORELSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDSB
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddsb:
        pms->VMONS.VDDSBCON.B.UVVAL = (uint16)(inputVoltage / IFXPMSEVR_SARCORELSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDSB */		
    default:
        /* Invalid Supply selected */
...
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDFLEX		
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddflex:
        pms->VMONS.VDDFLEXCON.B.UVMOD = mode;
        break;
#endif	/* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDFLEX */	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddpms0:
...
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddp3nvm:
        pms->VMONS.VDDP3NVMCON.B.UVMOD = mode;
        break;
#endif 	/* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM */	
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddexths:
        pms->VMONS.VDDEXTHSCON.B.UVMOD = mode;
        break;
#endif 	/* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS */	
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vdd3pms:
        pms->VMONS.VDD3PMSCON.B.UVMOD = mode;
        break;
#endif 	/* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif0:
        pms->VMONS.VDDRIF0CON.B.UVMOD = mode;
        break;
#endif 	/* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif0:
        pms->VMONS.VDDPHRIF0CON.B.UVMOD = mode;
        break;
#endif 	/* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif1:
        pms->VMONS.VDDPHRIF1CON.B.UVMOD = mode;
        break;
#endif 	/* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF2
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif2:
        pms->VMONS.VDDPHRIF2CON.B.UVMOD = mode;
        break;
#endif 	/* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF2 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif1:
        pms->VMONS.VDDRIF1CON.B.UVMOD = mode;
        break;
#endif 	/* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif2:
        pms->VMONS.VDDRIF2CON.B.UVMOD = mode;
        break;	
#endif 	/* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDSB
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddsb:
        pms->VMONS.VDDSBCON.B.UVMOD = mode;
        break;
#endif	/* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDSB */	
    default:
        /* Invalid Supply selected */
...
IFX_INLINE uint16 IfxPmsEvr_getPrimaryMonitorResult(Ifx_PMS *pms, IfxPmsEvr_PrimaryMonitorVoltageSource source)
{
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphphy1:
        ...
        break;
#endif /* IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHPHY1 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDHSIF	
...
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDFLEX	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddflex:
        result = pms->VMONS.VDDFLEXSTAT.B.RESULT;
        break;
#endif	/* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDFLEX */	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddpms0:
...
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddp3nvm:
        result = pms->VMONS.VDDP3NVMSTAT.B.RESULT;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM */
#if 	IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddexths:
        result = pms->VMONS.VDDEXTHSSTAT.B.RESULT;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vdd3pms:
        result = pms->VMONS.VDD3PMSSTAT.B.RESULT;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDSB
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddsb:
        result = pms->VMONS.VDDSBSTAT.B.RESULT;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDSB */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif0:
        result = pms->VMONS.VDDRIF0STAT.B.RESULT;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif0:
        result = pms->VMONS.VDDPHRIF0STAT.B.RESULT;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif1:
        result = pms->VMONS.VDDPHRIF1STAT.B.RESULT;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF2
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif2:
        result = pms->VMONS.VDDPHRIF2STAT.B.RESULT;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF2 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif1:
        result = pms->VMONS.VDDRIF1STAT.B.RESULT;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif2:
        result = pms->VMONS.VDDRIF2STAT.B.RESULT;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2 */	
    default:
        /* Invalid Supply selected */
...
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDSB	
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddsb:
        status = pms->VMONP.VDDSBSTAT.U;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDSB */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddp3nvm:
        status = pms->VMONP.VDDP3NVMSTAT.U;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddexths:
        status = pms->VMONP.VDDEXTHSSTAT.U;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vdd3pms:
        status = pms->VMONP.VDD3PMSSTAT.U;	
		break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphrif0:
        status = pms->VMONP.VDDPHRIF0STAT.U;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif0:
        status = pms->VMONP.VDDRIF0STAT.U;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphrif1:
        status = pms->VMONP.VDDPHRIF1STAT.U;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif1:
        status = pms->VMONP.VDDRIF1STAT.U;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif2:
        status = pms->VMONP.VDDRIF2STAT.U;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2 */
    default:
        /* Invalid Supply selected */
...
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDFLEX		
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddflex:
        status = pms->VMONS.VDDFLEXSTAT.U;
        break;
#endif	/* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDFLEX */	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddpms0:
...
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddp3nvm:
        status = pms->VMONS.VDDP3NVMSTAT.U;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS		
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddexths:
        status = pms->VMONS.VDDEXTHSSTAT.U;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vdd3pms:
        status = pms->VMONS.VDD3PMSSTAT.U;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif0:
        status = pms->VMONS.VDDRIF0STAT.U;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif0:
        status = pms->VMONS.VDDPHRIF0STAT.U;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif1:
        status = pms->VMONS.VDDPHRIF1STAT.U;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF2
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif2:
        status = pms->VMONS.VDDPHRIF2STAT.U;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF2 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif1:
        status = pms->VMONS.VDDRIF1STAT.U;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif2:
        status = pms->VMONS.VDDRIF2STAT.U;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDSB
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddsb:
        status = pms->VMONS.VDDSBSTAT.U;
        break;
#endif 	/* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDSB */
    default:
        /* Invalid Supply selected */
...
IFX_INLINE float32 IfxPmsEvr_getPrimaryMonitorResultMv(Ifx_PMS *pms, IfxPmsEvr_PrimaryMonitorVoltageSource source)
{
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphphy1:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        result = (pms->VMONP.VDDPHPHY1STAT.B.RESULT) * IFXPMSEVR_SARMVLSB_MV;
#else
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddhsif:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        result = (pms->VMONP.VDDHSIFSTAT.B.RESULT) * IFXPMSEVR_SARMVLSB_MV;
#else
...
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDSB				
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddsb:
        result = (pms->VMONP.VDDSBSTAT.B.RESULT) * IFXPMSEVR_SARHVLSB_MV;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDSB */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddp3nvm:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        result = (pms->VMONP.VDDP3NVMSTAT.B.RESULT) * IFXPMSEVR_SARMVLSB_MV;
#else
        result = (pms->VMONP.VDDP3NVMSTAT.B.RESULT) * IFXPMSEVR_SARHVLSB_MV;
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741  */
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddexths:
        result = (pms->VMONP.VDDEXTHSSTAT.B.RESULT) * IFXPMSEVR_SARHVLSB_MV;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS */		
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vdd3pms:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        result = (pms->VMONP.VDD3PMSSTAT.B.RESULT) * IFXPMSEVR_SARMVLSB_MV;
#else
        result = (pms->VMONP.VDD3PMSSTAT.B.RESULT) * IFXPMSEVR_SARHVLSB_MV;
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741 */
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphrif0:
        result = (pms->VMONP.VDDPHRIF0STAT.B.RESULT) * IFXPMSEVR_SARHVLSB_MV;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif0:
        result = (pms->VMONP.VDDRIF0STAT.B.RESULT) * IFXPMSEVR_SARCORELSB_MV;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphrif1:
        result = (pms->VMONP.VDDPHRIF1STAT.B.RESULT) * IFXPMSEVR_SARHVLSB_MV;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif1:
        result = (pms->VMONP.VDDRIF1STAT.B.RESULT) * IFXPMSEVR_SARCORELSB_MV;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif2:
        result = (pms->VMONP.VDDRIF2STAT.B.RESULT) * IFXPMSEVR_SARCORELSB_MV;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2 */
    default:
        /* Invalid Supply selected */
...
IFX_INLINE float32 IfxPmsEvr_getSecondaryMonitorResultMv(Ifx_PMS *pms, IfxPmsEvr_SecondaryMonitorVoltageSource source)
{
    ...
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphphy1:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        result = (pms->VMONS.VDDPHPHY1STAT.B.RESULT) * IFXPMSEVR_SARMVLSB_MV;
#else
    ...
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddhsif:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        result = (pms->VMONS.VDDHSIFSTAT.B.RESULT) * IFXPMSEVR_SARMVLSB_MV;
#else
...
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDFLEX
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddflex:
        result = (pms->VMONS.VDDFLEXSTAT.B.RESULT) * IFXPMSEVR_SARHVLSB_MV;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDFLEX */	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddpms0:
    ...
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddp3nvm:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        result = (pms->VMONS.VDDP3NVMSTAT.B.RESULT) * IFXPMSEVR_SARMVLSB_MV;
#else
        result = (pms->VMONS.VDDP3NVMSTAT.B.RESULT) * IFXPMSEVR_SARHVLSB_MV;
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741 */
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddexths:
        result = (pms->VMONS.VDDEXTHSSTAT.B.RESULT) * IFXPMSEVR_SARHVLSB_MV;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vdd3pms:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        result = (pms->VMONS.VDD3PMSSTAT.B.RESULT) * IFXPMSEVR_SARMVLSB_MV;
#else
        result = (pms->VMONP.VDD3PMSSTAT.B.RESULT) * IFXPMSEVR_SARHVLSB_MV;
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741 */
        break;
...
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDSB
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddsb:
        result = (pms->VMONS.VDDSBSTAT.B.RESULT) * IFXPMSEVR_SARCORELSB_MV;
        break;
#endif	/* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDSB */	
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif0:
        result = (pms->VMONS.VDDRIF0STAT.B.RESULT) * IFXPMSEVR_SARCORELSB_MV;
        break;
#endif	/* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0 */	
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif0:
        result = (pms->VMONS.VDDPHRIF0STAT.B.RESULT) * IFXPMSEVR_SARHVLSB_MV;
        break;
#endif	/* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0 */	
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif1:
        result = (pms->VMONS.VDDPHRIF1STAT.B.RESULT) * IFXPMSEVR_SARHVLSB_MV;
        break;
#endif	/* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1 */	
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF2
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif2:
        result = (pms->VMONS.VDDPHRIF2STAT.B.RESULT) * IFXPMSEVR_SARHVLSB_MV;
        break;
#endif	/* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF2 */	
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif1:
        result = (pms->VMONS.VDDRIF1STAT.B.RESULT) * IFXPMSEVR_SARCORELSB_MV;
        break;
#endif	/* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1 */	
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif2:
        result = (pms->VMONS.VDDRIF2STAT.B.RESULT) * IFXPMSEVR_SARCORELSB_MV;
        break;
#endif	/* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2 */	
    default:
        /* Invalid Supply selected */
...
IFX_INLINE void IfxPmsEvr_setPrimaryUnderVoltageThresholdMv(Ifx_PMS *pms, float32 underVoltage, IfxPmsEvr_PrimaryMonitorVoltageSource supply)
{
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vdd:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        pms->VMONP.VDDCON.B.UVVAL = (uint16)(underVoltage / IFXPMSEVR_TRKCORELSB_MV);
#else
...
#else 
 		pms->VMONP.VDDEXTCON.B.UVVAL = (uint16)(underVoltage / IFXPMSEVR_SARHVLSB_MV);
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741 */
        break;
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VSSDCHS
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vssdchs:
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphphy1:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        pms->VMONP.VDDPHPHY1CON.B.UVVAL = (uint16)(underVoltage / IFXPMSEVR_SARMVLSB_MV);
#else
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddhsif:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        pms->VMONP.VDDHSIFCON.B.UVVAL = (uint16)(underVoltage / IFXPMSEVR_SARMVLSB_MV);
#else
...
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDSB
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddsb:
        pms->VMONP.VDDSBCON.B.UVVAL = (uint16)(underVoltage / IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDSB */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddp3nvm:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        pms->VMONP.VDDP3NVMCON.B.UVVAL = (uint16)(underVoltage / IFXPMSEVR_SARMVLSB_MV);
#else
        pms->VMONP.VDDP3NVMCON.B.UVVAL = (uint16)(underVoltage / IFXPMSEVR_SARHVLSB_MV);
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741 */
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddexths:
        pms->VMONP.VDDEXTHSCON.B.UVVAL = (uint16)(underVoltage / IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vdd3pms:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        pms->VMONP.VDD3PMSCON.B.UVVAL = (uint16)(underVoltage / IFXPMSEVR_SARMVLSB_MV);
#else
        pms->VMONP.VDD3PMSCON.B.UVVAL = (uint16)(underVoltage / IFXPMSEVR_SARHVLSB_MV);
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741 */
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS */	
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphrif0:
        pms->VMONP.VDDPHRIF0CON.B.UVVAL = (uint16)(underVoltage / IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0 */	
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif0:
        pms->VMONP.VDDRIF0CON.B.UVVAL = (uint16)(underVoltage / IFXPMSEVR_SARCORELSB_MV);
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0 */	
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphrif1:
        pms->VMONP.VDDPHRIF1CON.B.UVVAL = (uint16)(underVoltage / IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1 */	
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif1:
        pms->VMONP.VDDRIF1CON.B.UVVAL = (uint16)(underVoltage / IFXPMSEVR_SARCORELSB_MV);
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1 */	
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif2:
        pms->VMONP.VDDRIF2CON.B.UVVAL = (uint16)(underVoltage / IFXPMSEVR_SARCORELSB_MV);
        break;	
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2 */	
    default:
        /* Invalid Supply selected */
...
IFX_INLINE void IfxPmsEvr_setPrimaryOverVoltageThresholdMv(Ifx_PMS *pms, float32 overVoltage, IfxPmsEvr_PrimaryMonitorVoltageSource supply)
{
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vdd:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        pms->VMONP.VDDCON.B.OVVAL = (uint16)(overVoltage / IFXPMSEVR_TRKCORELSB_MV);
#else
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddext:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        pms->VMONP.VDDEXTCON.B.OVVAL = (uint16)(overVoltage / IFXPMSEVR_SARHVLSB_MV);
#else
...
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDSB	
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddsb:
        pms->VMONP.VDDSBCON.B.OVVAL = (uint16)(overVoltage / IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDSB */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddp3nvm:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        pms->VMONP.VDDP3NVMCON.B.OVVAL = (uint16)(overVoltage / IFXPMSEVR_SARMVLSB_MV);
#else
        pms->VMONP.VDDP3NVMCON.B.OVVAL = (uint16)(overVoltage / IFXPMSEVR_SARHVLSB_MV);
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741 */
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddexths:
        pms->VMONP.VDDEXTHSCON.B.OVVAL = (uint16)(overVoltage / IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vdd3pms:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        pms->VMONP.VDD3PMSCON.B.OVVAL = (uint16)(overVoltage / IFXPMSEVR_SARMVLSB_MV);
#else
        pms->VMONP.VDD3PMSCON.B.OVVAL = (uint16)(overVoltage / IFXPMSEVR_SARHVLSB_MV);
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741 */
        break;
#endif	/* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphrif0:
        pms->VMONP.VDDPHRIF0CON.B.OVVAL = (uint16)(overVoltage / IFXPMSEVR_SARHVLSB_MV);
        break;
#endif	/* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif0:
        pms->VMONP.VDDRIF0CON.B.OVVAL = (uint16)(overVoltage / IFXPMSEVR_SARCORELSB_MV);
        break;
#endif	/* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphrif1:
        pms->VMONP.VDDPHRIF1CON.B.OVVAL = (uint16)(overVoltage / IFXPMSEVR_SARHVLSB_MV);
        break;
#endif	/* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif1:
        pms->VMONP.VDDRIF1CON.B.OVVAL = (uint16)(overVoltage / IFXPMSEVR_SARCORELSB_MV);
        break;
#endif	/* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif2:
        pms->VMONP.VDDRIF2CON.B.OVVAL = (uint16)(overVoltage / IFXPMSEVR_SARCORELSB_MV);
        break;	
#endif	/* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2 */
    default:
        /* Invalid Supply selected */
...
IFX_INLINE float32 IfxPmsEvr_getPeakVoltageDetectedValueinMv(Ifx_PMS *pms, IfxPmsEvr_PeakDetectionVoltageSource supply)
{
    ...
    case IfxPmsEvr_PeakDetectionVoltageSource_vddext:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        result = ((pms->PEAK.VDDEXTSTAT.B.PEAKVOLT) * IFXPMSEVR_SARHVLSB_MV);
#else
    ...
    case IfxPmsEvr_PeakDetectionVoltageSource_vddextdc:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        result = ((pms->PEAK.VDDEXTDCSTAT.B.PEAKVOLT) * IFXPMSEVR_SARHVLSB_MV);
#else
...
IFX_INLINE float32 IfxPmsEvr_getDriftMonitoringAverageVoltageMv(Ifx_PMS *pms, IfxPmsEvr_DriftMonitorVoltageSource source)
{
    ...
    case IfxPmsEvr_DriftMonitorVoltageSource_vdd:
        ...
        break;
    case IfxPmsEvr_DriftMonitorVoltageSource_vddext:
#if (IFXPMS_SUPPLY_RAIL_SARHV_4P741 == TRUE)
        average = (pms->DRMON.VDDEXTSTAT.B.VALUE * IFXPMSEVR_SARHVLSB_MV);
#elif (IFXPMS_SUPPLY_RAIL_SARHV_4P741 == FALSE)
        average = (pms->DRMON.VDDEXTSTAT.B.VALUE * IFXPMSEVR_TRKHVLSB_MV);
#endif /* (IFXPMS_SUPPLY_RAIL_SARHV_4P741 == TRUE) */
        break;
    case IfxPmsEvr_DriftMonitorVoltageSource_vddextdc:
#if (IFXPMS_SUPPLY_RAIL_SARHV_4P741 == TRUE)
        average = (pms->DRMON.VDDEXTDCSTAT.B.VALUE * IFXPMSEVR_SARHVLSB_MV);
#elif (IFXPMS_SUPPLY_RAIL_SARHV_4P741 == FALSE)
...
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDSB	
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddsb:
        pms->VMONP.VDDSBCON.B.UVENABLE = enable;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDSB */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddp3nvm:
        pms->VMONP.VDDP3NVMCON.B.UVENABLE = enable;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddexths:
        pms->VMONP.VDDEXTHSCON.B.UVENABLE = enable;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vdd3pms:
        pms->VMONP.VDD3PMSCON.B.UVENABLE = enable;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphrif0:
        pms->VMONP.VDDPHRIF0CON.B.UVENABLE = enable;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif0:
        pms->VMONP.VDDRIF0CON.B.UVENABLE = enable;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphrif1:
        pms->VMONP.VDDPHRIF1CON.B.UVENABLE = enable;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif1:
        pms->VMONP.VDDRIF1CON.B.UVENABLE = enable;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif2:
        pms->VMONP.VDDRIF2CON.B.UVENABLE = enable;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2 */
    default:
        /* Invalid Supply selected */
...
IFX_INLINE void IfxPmsEvr_enablePrimaryOverVoltageAlarm(Ifx_PMS *pms, IfxPmsEvr_PrimaryMonitorVoltageSource supply, boolean enable)
{
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphy1:
        ...
        break;
#endif /* IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHY1 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDLMU0		
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddlmu0:
...
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDSB
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddsb:
        pms->VMONP.VDDSBCON.B.OVENABLE = enable;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDSB */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddp3nvm:
        pms->VMONP.VDDP3NVMCON.B.OVENABLE = enable;
        break;	
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddexths:
        pms->VMONP.VDDEXTHSCON.B.OVENABLE = enable;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vdd3pms:
        pms->VMONP.VDD3PMSCON.B.OVENABLE = enable;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphrif0:
        pms->VMONP.VDDPHRIF0CON.B.OVENABLE = enable;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif0:
        pms->VMONP.VDDRIF0CON.B.OVENABLE = enable;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphrif1:
        pms->VMONP.VDDPHRIF1CON.B.OVENABLE = enable;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif1:
        pms->VMONP.VDDRIF1CON.B.OVENABLE = enable;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif2:
        pms->VMONP.VDDRIF2CON.B.OVENABLE = enable;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2 */	
    default:
        /* Invalid Supply selected */
...
IFX_INLINE uint16 IfxPmsEvr_getPrimaryUnderVoltageThresholdMv(Ifx_PMS *pms, IfxPmsEvr_PrimaryMonitorVoltageSource supply)
{
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vdd:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        mV = (uint16)(pms->VMONP.VDDCON.B.UVVAL * IFXPMSEVR_TRKCORELSB_MV);
#else
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddext:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        mV = (uint16)(pms->VMONP.VDDEXTCON.B.UVVAL * IFXPMSEVR_SARHVLSB_MV);
#else
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphphy1:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        mV = (uint16)(pms->VMONP.VDDPHPHY1CON.B.UVVAL * IFXPMSEVR_SARMVLSB_MV);
#else
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddhsif:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        mV = (uint16)(pms->VMONP.VDDHSIFCON.B.UVVAL * IFXPMSEVR_SARMVLSB_MV);
#else
...
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDSB	
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddsb:
        mV = (uint16)(pms->VMONP.VDDSBCON.B.UVVAL * IFXPMSEVR_SARCORELSB_MV);
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDSB */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddp3nvm:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        mV = (uint16)(pms->VMONP.VDDP3NVMCON.B.UVVAL * IFXPMSEVR_SARMVLSB_MV);
#else
        mV = (uint16)(pms->VMONP.VDDP3NVMCON.B.UVVAL * IFXPMSEVR_SARHVLSB_MV);
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741 */
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddexths:
        mV = (uint16)(pms->VMONP.VDDEXTHSCON.B.UVVAL * IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vdd3pms:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        mV = (uint16)(pms->VMONP.VDD3PMSCON.B.UVVAL * IFXPMSEVR_SARMVLSB_MV);
#else
        mV = (uint16)(pms->VMONP.VDD3PMSCON.B.UVVAL * IFXPMSEVR_SARHVLSB_MV);
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741 */
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphrif0:
        mV = (uint16)(pms->VMONP.VDDPHRIF0CON.B.UVVAL * IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif0:
        mV = (uint16)(pms->VMONP.VDDRIF0CON.B.UVVAL * IFXPMSEVR_SARCORELSB_MV);
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphrif1:
        mV = (uint16)(pms->VMONP.VDDPHRIF1CON.B.UVVAL * IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif1:
        mV = (uint16)(pms->VMONP.VDDRIF1CON.B.UVVAL * IFXPMSEVR_SARCORELSB_MV);
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif2:
        mV = (uint16)(pms->VMONP.VDDRIF2CON.B.UVVAL * IFXPMSEVR_SARCORELSB_MV);
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2 */
    default:
        /* Invalid Supply selected */
...
IFX_INLINE uint16 IfxPmsEvr_getPrimaryOverVoltageThresholdMv(Ifx_PMS *pms, IfxPmsEvr_PrimaryMonitorVoltageSource supply)
{
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vdd:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        mV = (uint16)(pms->VMONP.VDDCON.B.OVVAL * IFXPMSEVR_TRKCORELSB_MV);
#else
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddext:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        mV = (uint16)(pms->VMONP.VDDEXTCON.B.OVVAL * IFXPMSEVR_SARHVLSB_MV);
#else
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphphy1:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        mV = (uint16)(pms->VMONP.VDDPHPHY1CON.B.OVVAL * IFXPMSEVR_SARMVLSB_MV);
#else
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddhsif:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        mV = (uint16)(pms->VMONP.VDDHSIFCON.B.OVVAL * IFXPMSEVR_SARMVLSB_MV);
#else
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddppu:
        ...
        break;
#endif /* IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPPU */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHY0		
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphy0:
...
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDSB
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddsb:
        mV = (uint16)(pms->VMONP.VDDSBCON.B.OVVAL * IFXPMSEVR_SARCORELSB_MV);
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDSB */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddp3nvm:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        mV = (uint16)(pms->VMONP.VDDP3NVMCON.B.OVVAL * IFXPMSEVR_SARMVLSB_MV);
#else
        mV = (uint16)(pms->VMONP.VDDP3NVMCON.B.OVVAL * IFXPMSEVR_SARHVLSB_MV);
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741 */
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddexths:
        mV = (uint16)(pms->VMONP.VDDEXTHSCON.B.OVVAL * IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vdd3pms:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        mV = (uint16)(pms->VMONP.VDD3PMSCON.B.OVVAL * IFXPMSEVR_SARMVLSB_MV);
#else
        mV = (uint16)(pms->VMONP.VDD3PMSCON.B.OVVAL * IFXPMSEVR_SARHVLSB_MV);
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741 */
        break;
#endif	/* 	#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphrif0:
        mV = (uint16)(pms->VMONP.VDDPHRIF0CON.B.OVVAL * IFXPMSEVR_SARHVLSB_MV);
        break;
#endif	/* 	#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif0:
        mV = (uint16)(pms->VMONP.VDDRIF0CON.B.OVVAL * IFXPMSEVR_SARCORELSB_MV);
        break;
#endif	/* 	#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphrif1:
        mV = (uint16)(pms->VMONP.VDDPHRIF1CON.B.OVVAL * IFXPMSEVR_SARHVLSB_MV);
        break;
#endif	/* 	#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif1:
        mV = (uint16)(pms->VMONP.VDDRIF1CON.B.OVVAL * IFXPMSEVR_SARCORELSB_MV);
        break;
#endif	/* 	#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif2:
        mV = (uint16)(pms->VMONP.VDDRIF2CON.B.OVVAL * IFXPMSEVR_SARCORELSB_MV);
        break;
#endif	/* 	#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2 */
    default:
        /* Invalid Supply selected */
...
IFX_INLINE uint16 IfxPmsEvr_getRstVoltageThresholdMv(Ifx_PMS *pms, IfxPmsEvr_PrimaryMonitorVoltageSource supply)
{
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vdd:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        mV = (uint16)(pms->VMONP.VDDRST.B.RESETTRIM * IFXPMSEVR_TRKCORELSB_MV);
#else
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddext:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        mV = (uint16)(pms->VMONP.VDDEXTRST.B.RESETTRIM * IFXPMSEVR_SARHVLSB_MV);
#else
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphphy1:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        mV = (uint16)(pms->VMONP.VDDPHPHY1RST.B.RESETTRIM * IFXPMSEVR_SARMVLSB_MV);
#else
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddhsif:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        mV = (uint16)(pms->VMONP.VDDHSIFRST.B.RESETTRIM * IFXPMSEVR_SARMVLSB_MV);
#else
...
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDSB	
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddsb:
        mV = (uint16)(pms->VMONP.VDDSBRST.B.RESETTRIM * IFXPMSEVR_SARCORELSB_MV);
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDSB	 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddp3nvm:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        mV = (uint16)(pms->VMONP.VDDP3NVMRST.B.RESETTRIM * IFXPMSEVR_SARMVLSB_MV);
#else
        mV = (uint16)(pms->VMONP.VDDP3NVMRST.B.RESETTRIM * IFXPMSEVR_SARHVLSB_MV);
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741 */
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddexths:
        mV = (uint16)(pms->VMONP.VDDEXTHSRST.B.RESETTRIM * IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vdd3pms:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741 
        mV = (uint16)(pms->VMONP.VDD3PMSRST.B.RESETTRIM * IFXPMSEVR_SARMVLSB_MV);
#else
        mV = (uint16)(pms->VMONP.VDD3PMSRST.B.RESETTRIM * IFXPMSEVR_SARHVLSB_MV);
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741  */
        break;
#endif	/* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphrif0:
        mV = (uint16)(pms->VMONP.VDDPHRIF0RST.B.RESETTRIM * IFXPMSEVR_SARHVLSB_MV);
        break;
#endif	/* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif0:
        mV = (uint16)(pms->VMONP.VDDRIF0RST.B.RESETTRIM * IFXPMSEVR_SARCORELSB_MV);
        break;
#endif	/* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphrif1:
        mV = (uint16)(pms->VMONP.VDDPHRIF1RST.B.RESETTRIM * IFXPMSEVR_SARHVLSB_MV);
        break;
#endif	/* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif1:
        mV = (uint16)(pms->VMONP.VDDRIF1RST.B.RESETTRIM * IFXPMSEVR_SARCORELSB_MV);
        break;
#endif	/* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif2:
        mV = (uint16)(pms->VMONP.VDDRIF2RST.B.RESETTRIM * IFXPMSEVR_SARCORELSB_MV);
        break;
#endif	/* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2 */	
    default:
        /* Invalid Supply selected */
...
IFX_INLINE void IfxPmsEvr_setRstVoltageThresholdMv(Ifx_PMS *pms, uint16 voltage, IfxPmsEvr_PrimaryMonitorVoltageSource supply)
{
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vdd:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        pms->VMONP.VDDRST.B.RESETTRIM = (uint16)(voltage / IFXPMSEVR_TRKCORELSB_MV);
#else
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddext:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741 
        pms->VMONP.VDDEXTRST.B.RESETTRIM = (uint16)(voltage / IFXPMSEVR_SARHVLSB_MV);
#else
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphphy0:
        ...
        break;
#endif	/* IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHPHY0 */	
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHPHY1	
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphphy1:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        pms->VMONP.VDDPHPHY1RST.B.RESETTRIM = (uint16)(voltage / IFXPMSEVR_SARMVLSB_MV);
#else
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddhsif:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        pms->VMONP.VDDHSIFRST.B.RESETTRIM = (uint16)(voltage / IFXPMSEVR_SARMVLSB_MV);
#else
    ...
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphy0:
        ...
        break;
#endif	/* IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHY0 */	
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHY1
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphy1:
...
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDSB		
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddsb:
        pms->VMONP.VDDSBRST.B.RESETTRIM = (uint16)(voltage / IFXPMSEVR_SARCORELSB_MV);
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDSB */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddp3nvm:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741 
        pms->VMONP.VDDP3NVMRST.B.RESETTRIM = (uint16)(voltage / IFXPMSEVR_SARMVLSB_MV);
#else
        pms->VMONP.VDDP3NVMRST.B.RESETTRIM = (uint16)(voltage / IFXPMSEVR_SARHVLSB_MV);
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741  */
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddexths:
        pms->VMONP.VDDEXTHSRST.B.RESETTRIM = (uint16)(voltage / IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vdd3pms:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741 
        pms->VMONP.VDD3PMSRST.B.RESETTRIM = (uint16)(voltage / IFXPMSEVR_SARMVLSB_MV);
#else
        pms->VMONP.VDD3PMSRST.B.RESETTRIM = (uint16)(voltage / IFXPMSEVR_SARHVLSB_MV);
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741  */
        break;
#endif	/* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS */	
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphrif0:
        pms->VMONP.VDDPHRIF0RST.B.RESETTRIM = (uint16)(voltage / IFXPMSEVR_SARHVLSB_MV);
        break;
#endif	/* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0 */	
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif0:
        pms->VMONP.VDDRIF0RST.B.RESETTRIM = (uint16)(voltage / IFXPMSEVR_SARCORELSB_MV);
        break;
#endif	/* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0 */	
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphrif1:
        pms->VMONP.VDDPHRIF1RST.B.RESETTRIM = (uint16)(voltage / IFXPMSEVR_SARHVLSB_MV);
        break;
#endif	/* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1 */	
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif1:
        pms->VMONP.VDDRIF1RST.B.RESETTRIM = (uint16)(voltage / IFXPMSEVR_SARCORELSB_MV);
        break;
#endif	/* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1 */	
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif2:
        pms->VMONP.VDDRIF2RST.B.RESETTRIM = (uint16)(voltage / IFXPMSEVR_SARCORELSB_MV);
        break;
#endif	/* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2 */	
    default:
        /* Invalid Supply selected */
...
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDSB	
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddsb:
        flag = pms->VMONP.VDDSBCON.B.UVENABLE;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDSB */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM	
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddp3nvm:
        flag = pms->VMONP.VDDP3NVMCON.B.UVENABLE;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS	
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddexths:
        flag = pms->VMONP.VDDEXTHSCON.B.UVENABLE;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS	
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vdd3pms:
        flag = pms->VMONP.VDD3PMSCON.B.UVENABLE;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphrif0:
        flag = pms->VMONP.VDDPHRIF0CON.B.UVENABLE;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0	
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif0:
        flag = pms->VMONP.VDDRIF0CON.B.UVENABLE;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1	
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphrif1:
        flag = pms->VMONP.VDDPHRIF1CON.B.UVENABLE;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1	
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif1:
        flag = pms->VMONP.VDDRIF1CON.B.UVENABLE;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2	
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif2:
        flag = pms->VMONP.VDDRIF2CON.B.UVENABLE;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2 */
    default:
        /* Invalid Supply selected */
...
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDSB	
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddsb:
        flag = pms->VMONP.VDDSBCON.B.OVENABLE;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDSB */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM	
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddp3nvm:
        flag = pms->VMONP.VDDP3NVMCON.B.OVENABLE;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddexths:
        flag = pms->VMONP.VDDEXTHSCON.B.OVENABLE;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS	
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vdd3pms:
        flag = pms->VMONP.VDD3PMSCON.B.OVENABLE;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0	
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphrif0:
        flag = pms->VMONP.VDDPHRIF0CON.B.OVENABLE;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0	
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif0:
        flag = pms->VMONP.VDDRIF0CON.B.OVENABLE;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1	
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddphrif1:
        flag = pms->VMONP.VDDPHRIF1CON.B.OVENABLE;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1	
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif1:
        flag = pms->VMONP.VDDRIF1CON.B.OVENABLE;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1 */
#if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2	
    case IfxPmsEvr_PrimaryMonitorVoltageSource_vddrif2:
        flag = pms->VMONP.VDDRIF2CON.B.OVENABLE;
        break;
#endif /* #if IFXPMS_PRIMARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2 */
    default:
        /* Invalid Supply selected */
...
IFX_INLINE uint16 IfxPmsEvr_getSecondaryUnderVoltageThresholdMv(Ifx_PMS *pms, IfxPmsEvr_SecondaryMonitorVoltageSource source)
{
    ...
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphphy1:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        mV = (uint16)(pms->VMONS.VDDPHPHY1CON.B.UVVAL * IFXPMSEVR_SARMVLSB_MV);
#else
    ...
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddhsif:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        mV = (uint16)(pms->VMONS.VDDHSIFCON.B.UVVAL * IFXPMSEVR_SARMVLSB_MV);
#else
...
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDFLEX			
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddflex:
        mV = (uint16)(pms->VMONS.VDDFLEXCON.B.UVVAL * IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDFLEX */
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddpms0:
    ...
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddp3nvm:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741 
        mV = (uint16)(pms->VMONS.VDDP3NVMCON.B.UVVAL * IFXPMSEVR_SARMVLSB_MV);
#else
        mV = (uint16)(pms->VMONS.VDDP3NVMCON.B.UVVAL * IFXPMSEVR_SARHVLSB_MV);
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741  */
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddexths:
        mV = (uint16)(pms->VMONS.VDDEXTHSCON.B.UVVAL * IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS		
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vdd3pms:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741 
        mV = (uint16)(pms->VMONS.VDD3PMSCON.B.UVVAL * IFXPMSEVR_SARMVLSB_MV);
#else
        mV = (uint16)(pms->VMONS.VDD3PMSCON.B.UVVAL * IFXPMSEVR_SARHVLSB_MV);
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741  */
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0		
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif0:
        mV = (uint16)(pms->VMONS.VDDRIF0CON.B.UVVAL * IFXPMSEVR_SARCORELSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif0:
        mV = (uint16)(pms->VMONS.VDDPHRIF0CON.B.UVVAL * IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif1:
        mV = (uint16)(pms->VMONS.VDDPHRIF1CON.B.UVVAL * IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF2	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif2:
        mV = (uint16)(pms->VMONS.VDDPHRIF2CON.B.UVVAL * IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF2 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1		
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif1:
        mV = (uint16)(pms->VMONS.VDDRIF1CON.B.UVVAL * IFXPMSEVR_SARCORELSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2		
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif2:
        mV = (uint16)(pms->VMONS.VDDRIF2CON.B.UVVAL * IFXPMSEVR_SARCORELSB_MV);
        break;		
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDSB		
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddsb:
        mV = (uint16)(pms->VMONS.VDDSBCON.B.UVVAL * IFXPMSEVR_SARCORELSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDSB */
    default:
        /* Invalid Supply selected */
...
IFX_INLINE uint16 IfxPmsEvr_getSecondaryOverVoltageThresholdMv(Ifx_PMS *pms, IfxPmsEvr_SecondaryMonitorVoltageSource source)
{
    ...
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphphy1:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        mV = (uint16)(pms->VMONS.VDDPHPHY1CON.B.OVVAL * IFXPMSEVR_SARMVLSB_MV);
#else
    ...
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddhsif:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741
        mV = (uint16)(pms->VMONS.VDDHSIFCON.B.OVVAL * IFXPMSEVR_SARMVLSB_MV);
#else
...
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDFLEX			
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddflex:
        mV = (uint16)(pms->VMONS.VDDFLEXCON.B.OVVAL * IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDFLEX */
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddpms0:
    ...
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddp3nvm:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741 
        mV = (uint16)(pms->VMONS.VDDP3NVMCON.B.OVVAL * IFXPMSEVR_SARMVLSB_MV);
#else
        mV = (uint16)(pms->VMONS.VDDP3NVMCON.B.OVVAL * IFXPMSEVR_SARHVLSB_MV);
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741  */
        break;	
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS	
    ...
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vdd3pms:
#if IFXPMS_SUPPLY_RAIL_SARHV_4P741 
        mV = (uint16)(pms->VMONS.VDD3PMSCON.B.OVVAL * IFXPMSEVR_SARMVLSB_MV);
#else
        mV = (uint16)(pms->VMONS.VDD3PMSCON.B.OVVAL * IFXPMSEVR_SARHVLSB_MV);
#endif /* #if IFXPMS_SUPPLY_RAIL_SARHV_4P741  */
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif0:
        mV = (uint16)(pms->VMONS.VDDRIF0CON.B.OVVAL * IFXPMSEVR_SARCORELSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif0:
        mV = (uint16)(pms->VMONS.VDDPHRIF0CON.B.OVVAL * IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif1:
        mV = (uint16)(pms->VMONS.VDDPHRIF1CON.B.OVVAL * IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF2	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif2:
        mV = (uint16)(pms->VMONS.VDDPHRIF2CON.B.OVVAL * IFXPMSEVR_SARHVLSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF2 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif1:
        mV = (uint16)(pms->VMONS.VDDRIF1CON.B.OVVAL * IFXPMSEVR_SARCORELSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2		
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif2:
        mV = (uint16)(pms->VMONS.VDDRIF2CON.B.OVVAL * IFXPMSEVR_SARCORELSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDSB	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddsb:
        mV = (uint16)(pms->VMONS.VDDSBCON.B.OVVAL * IFXPMSEVR_SARCORELSB_MV);
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDSB */
    default:
        /* Invalid Supply selected */
...
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDFLEX			
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddflex:
        mode = (IfxPmsEvr_OverVoltageMonitoring)pms->VMONS.VDDFLEXCON.B.OVMOD;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDFLEX */
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddpms0:
...
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM    
	case IfxPmsEvr_SecondaryMonitorVoltageSource_vddp3nvm:
        mode = (IfxPmsEvr_OverVoltageMonitoring)pms->VMONS.VDDP3NVMCON.B.OVMOD;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS			
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddexths:
        mode = (IfxPmsEvr_OverVoltageMonitoring)pms->VMONS.VDDEXTHSCON.B.OVMOD;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS		
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vdd3pms:
        mode = (IfxPmsEvr_OverVoltageMonitoring)pms->VMONS.VDD3PMSCON.B.OVMOD;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif0:
        mode = (IfxPmsEvr_OverVoltageMonitoring)pms->VMONS.VDDRIF0CON.B.OVMOD;
        break;	
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif0:
        mode = (IfxPmsEvr_OverVoltageMonitoring)pms->VMONS.VDDPHRIF0CON.B.OVMOD;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif1:
        mode = (IfxPmsEvr_OverVoltageMonitoring)pms->VMONS.VDDPHRIF1CON.B.OVMOD;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF2	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif2:
        mode = (IfxPmsEvr_OverVoltageMonitoring)pms->VMONS.VDDPHRIF2CON.B.OVMOD;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF2 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1		
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif1:
        mode = (IfxPmsEvr_OverVoltageMonitoring)pms->VMONS.VDDRIF1CON.B.OVMOD;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif2:
        mode = (IfxPmsEvr_OverVoltageMonitoring)pms->VMONS.VDDRIF2CON.B.OVMOD;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDSB		
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddsb:
        mode = (IfxPmsEvr_OverVoltageMonitoring)pms->VMONS.VDDSBCON.B.OVMOD;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDSB */
    default:
        /* Invalid Supply selected */
...
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDFLEX	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddflex:
        mode = (IfxPmsEvr_UnderVoltageMonitoring)pms->VMONS.VDDFLEXCON.B.UVMOD;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDFLEX */
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddpms0:
...
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddp3nvm:
        mode = (IfxPmsEvr_UnderVoltageMonitoring)pms->VMONS.VDDP3NVMCON.B.UVMOD;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDP3NVM */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddexths:
        mode = (IfxPmsEvr_UnderVoltageMonitoring)pms->VMONS.VDDEXTHSCON.B.UVMOD;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDEXTHS */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vdd3pms:
        mode = (IfxPmsEvr_UnderVoltageMonitoring)pms->VMONS.VDD3PMSCON.B.UVMOD;
        break;	
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDD3PMS */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0		
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif0:
        mode = (IfxPmsEvr_UnderVoltageMonitoring)pms->VMONS.VDDRIF0CON.B.UVMOD;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF0 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif0:
        mode = (IfxPmsEvr_UnderVoltageMonitoring)pms->VMONS.VDDPHRIF0CON.B.UVMOD;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF0 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif1:
        mode = (IfxPmsEvr_UnderVoltageMonitoring)pms->VMONS.VDDPHRIF1CON.B.UVMOD;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF1 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF2	
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddphrif2:
        mode = (IfxPmsEvr_UnderVoltageMonitoring)pms->VMONS.VDDPHRIF2CON.B.UVMOD;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDPHRIF2 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1		
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif1:
        mode = (IfxPmsEvr_UnderVoltageMonitoring)pms->VMONS.VDDRIF1CON.B.UVMOD;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF1 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2		
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddrif2:
        mode = (IfxPmsEvr_UnderVoltageMonitoring)pms->VMONS.VDDRIF2CON.B.UVMOD;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDRIF2 */
#if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDSB		
    case IfxPmsEvr_SecondaryMonitorVoltageSource_vddsb:
        mode = (IfxPmsEvr_UnderVoltageMonitoring)pms->VMONS.VDDSBCON.B.UVMOD;
        break;
#endif /* #if IFXPMS_SECONDARY_MONITOR_VOLTAGE_SOURCE_VDDSB */
    default:
        /* Invalid Supply selected */
...
IFX_INLINE void IfxPmsEvr_enableRifPrimaryReset(Ifx_PMS *pms)
{
    ...
    IfxApProt_setState((Ifx_PROT_PROT *)&(pms->PROTE), IfxApProt_State_config);
#endif
    Ifx_PMS_VMONPRST vddPhRif0Rst;
    vddPhRif0Rst.U            = pms->VMONP.VDDPHRIF0RST.U;
    vddPhRif0Rst.B.RESETOFF_P = 1u;
    vddPhRif0Rst.B.RESETOFF   = 0u;
    pms->VMONP.VDDPHRIF0RST.U = vddPhRif0Rst.U;
#if (IFX_PROT_ENABLED == 1U)
    IfxApProt_setState((Ifx_PROT_PROT *)&(pms->PROTE), IfxApProt_State_run);
#endif
}
