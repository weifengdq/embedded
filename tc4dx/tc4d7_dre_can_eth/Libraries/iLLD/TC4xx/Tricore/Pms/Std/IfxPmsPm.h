...
#if IFXPMS_IS_CORE_POWER_DOMAIN_AVAILABLE
/** \brief Enumeration for Core power domain
 */
typedef enum
{
#if IFXPMS_IS_CORE_POWER_DOMAIN_CPU_AVAILABLE
    IfxPmsPm_CorePowerDomain_cpuA  = 0,  /**< \brief CPUA power domain */
    IfxPmsPm_CorePowerDomain_cpuB  = 1,  /**< \brief CPUB power domain */
#endif	/* #if IFXPMS_IS_CORE_POWER_DOMAIN_CPU_AVAILABLE */
#if IFXPMS_IS_CORE_POWER_DOMAIN_PPU_AVAILABLE
    IfxPmsPm_CorePowerDomain_ppu   = 3,  /**< \brief PPU power domain */
#endif /* #if IFXPMS_IS_CORE_POWER_DOMAIN_PPU_AVAILABLE */
#if IFXPMS_IS_CORE_POWER_DOMAIN_EMEM_AVAILABLE
    IfxPmsPm_CorePowerDomain_ememA = 4,  /**< \brief EMEMA power domain */
    IfxPmsPm_CorePowerDomain_ememB = 5,  /**< \brief EMEMB power domain */
    IfxPmsPm_CorePowerDomain_ememC = 6,  /**< \brief EMEMC power domain */
    IfxPmsPm_CorePowerDomain_ememD = 7   /**< \brief EMEMD power domain */
#endif /* #if IFXPMS_IS_CORE_POWER_DOMAIN_EMEM_AVAILABLE */
#if IFXPMS_IS_CORE_POWER_DOMAIN_LMU_AVAILABLE	
    IfxPmsPm_CorePowerDomain_lmu0 = 8,   /**< \brief LMU power domain */
    IfxPmsPm_CorePowerDomain_lmu1 = 9    /**< \brief LMU1 power domain */
#endif	/* #if IFXPMS_IS_CORE_POWER_DOMAIN_LMU_AVAILABLE */
...
#if IFXPMS_IS_POWER_DOMAIN_SWITCH_AVAILABLE
...
#endif /* #if IFXPMS_IS_POWER_DOMAIN_SWITCH_AVAILABLE */
...
typedef enum
{
    ...
    IfxPmsPm_StandbyRamSupply_cpu0_128Kb            = 3,  /**< \brief Standby RAM CPU0 dLMU 128kB is supplied */
    IfxPmsPm_StandbyRamSupply_cpu1_64Kb             = 16, /**< \brief Standby RAM (CPU1 dLMU 64kB are supplied) is supplied */
    IfxPmsPm_StandbyRamSupply_cpu0_64Kb_cpu1_64Kb   = 17, /**< \brief Standby RAM (CPU0 dLMU 64kB and CPU1 dLMU 64kB are supplied) is supplied */
    IfxPmsPm_StandbyRamSupply_cpu0_128Kb_cpu1_64Kb  = 19, /**< \brief Standby RAM (CPU0 dLMU 128kB and CPU1 dLMU 64kB are supplied) is supplied */
    IfxPmsPm_StandbyRamSupply_cpu1_128Kb            = 48, /**< \brief Standby RAM (CPU1 dLMU 128kB are supplied) is supplied */
    IfxPmsPm_StandbyRamSupply_cpu0_64Kb_cpu1_128Kb  = 49, /**< \brief Standby RAM (CPU0 dLMU 64kB and CPU1 dLMU 128kB are supplied) is supplied */
...
typedef struct
{
#if IFXPMS_IS_PPU_POWER_DOWN_MODE_AVAILABLE
    IfxPmsPm_PowerDown ppu;        /**< \brief Enable/Disable power down of PPU power domain */
#endif /* #if IFXPMS_IS_PPU_POWER_DOWN_MODE_AVAILABLE */
#if IFXPMS_IS_LMU_POWER_DOWN_MODE_AVAILABLE	
...
#endif	/* #if IFXPMS_IS_LMU_POWER_DOWN_MODE_AVAILABLE */
...
#if IFXPMS_IS_POWER_GATING_PPU_CLK_DIVIDER_AVAILABLE
    IfxPmsPm_PowerSwitchCLockDivider ppuClkDivider;       /**< \brief PPU power switch rate clock divider */
#endif /* #if IFXPMS_IS_POWER_GATING_PPU_CLK_DIVIDER_AVAILABLE */
#if IFXPMS_IS_POWER_GATING_LMU_CLK_DIVIDER_AVAILABLE	
    IfxPmsPm_PowerSwitchCLockDivider lmuClkDivider;       /**< \brief LMU power switch rate clock divider. */
#endif /* #if IFXPMS_IS_POWER_GATING_LMU_CLK_DIVIDER_AVAILABLE */
