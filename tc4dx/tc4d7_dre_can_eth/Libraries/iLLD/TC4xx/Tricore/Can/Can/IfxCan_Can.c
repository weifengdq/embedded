...
void IfxCan_Can_initCre(IfxCan_Can_Node *node, IfxCan_CreConfig *config)
{
    ...
    if (config->interrupt.rxBuffer0InterruptEnable)
    {
        ...
        if ((config->interrupt.rxHBuf0.priority > 0) || (config->interrupt.rxHBuf0.typeOfService == IfxSrc_Tos_dma0))
#endif
        {
    ...
    if (config->interrupt.rxBuffer1InterruptEnable)
    {
        ...
        if ((config->interrupt.rxHBuf1.priority > 0) || (config->interrupt.rxHBuf1.typeOfService == IfxSrc_Tos_dma0))
#endif
        {
    ...
    if (config->interrupt.txBuffer0InterruptEnable)
    {
        ...
        if ((config->interrupt.txHBuf0.priority > 0) || (config->interrupt.txHBuf0.typeOfService == IfxSrc_Tos_dma0))
#endif
        {
    ...
    if (config->interrupt.txBuffer1InterruptEnable)
    {
        ...
        if ((config->interrupt.txHBuf1.priority > 0) || (config->interrupt.txHBuf1.typeOfService == IfxSrc_Tos_dma0))
#endif
        {
    ...
    if (config->interrupt.IdmuStdFrameRateMeasurementLostInterruptEnable || config->interrupt.IdmuXtdFrameRateMeasurementLostInterruptEnable)
    {
        ...
        if ((config->interrupt.idmu.priority > 0) || (config->interrupt.idmu.typeOfService == IfxSrc_Tos_dma0))
#endif
        {
    ...
    if (config->interrupt.creErrorInterruptEnable)
    {
        ...
        if ((config->interrupt.creError.priority > 0) || (config->interrupt.creError.typeOfService == IfxSrc_Tos_dma0))
#endif
        {
...
boolean IfxCan_Can_initNode(IfxCan_Can_Node *node, const IfxCan_Can_NodeConfig *config)
{
    ...
    if ((config->interruptConfig.tefifo.priority > 0) || (config->interruptConfig.tefifo.typeOfService == IfxSrc_Tos_dma0))
#endif
    {
    ...
    if ((config->interruptConfig.hpe.priority > 0) || (config->interruptConfig.hpe.typeOfService == IfxSrc_Tos_dma0))
#endif
    {
    ...
    if ((config->interruptConfig.wati.priority > 0) || (config->interruptConfig.wati.typeOfService == IfxSrc_Tos_dma0))
#endif
    {
    ...
    if ((config->interruptConfig.alrt.priority > 0) || (config->interruptConfig.alrt.typeOfService == IfxSrc_Tos_dma0))
#endif
    {
    ...
    if ((config->interruptConfig.moer.priority > 0) || (config->interruptConfig.moer.typeOfService == IfxSrc_Tos_dma0))
#endif
    {
    ...
    if ((config->interruptConfig.safe.priority > 0) || (config->interruptConfig.safe.typeOfService == IfxSrc_Tos_dma0))
#endif
    {
    ...
    if ((config->interruptConfig.boff.priority > 0) || (config->interruptConfig.boff.typeOfService == IfxSrc_Tos_dma0))
#endif
    {
    ...
    if ((config->interruptConfig.loi.priority > 0) || (config->interruptConfig.loi.typeOfService == IfxSrc_Tos_dma0))
#endif
    {
    ...
    if ((config->interruptConfig.reint.priority > 0) || (config->interruptConfig.reint.typeOfService == IfxSrc_Tos_dma0))
#endif
    {
    ...
    if ((config->interruptConfig.rxf1f.priority > 0) || (config->interruptConfig.rxf1f.typeOfService == IfxSrc_Tos_dma0))
#endif
    {
    ...
    if ((config->interruptConfig.rxf0f.priority > 0) || (config->interruptConfig.rxf0f.typeOfService == IfxSrc_Tos_dma0))
#endif
    {
    ...
    if ((config->interruptConfig.rxf1n.priority > 0) || (config->interruptConfig.rxf1f.typeOfService == IfxSrc_Tos_dma0))
#endif
    {
    ...
    if ((config->interruptConfig.rxf0n.priority > 0) || (config->interruptConfig.rxf0n.typeOfService == IfxSrc_Tos_dma0))
#endif
    {
    ...
    if ((config->interruptConfig.reti.priority > 0) || (config->interruptConfig.reti.typeOfService == IfxSrc_Tos_dma0))
#endif
    {
    ...
    if ((config->interruptConfig.traq.priority > 0) || (config->interruptConfig.traq.typeOfService == IfxSrc_Tos_dma0))
#endif
    {
    ...
    if ((config->interruptConfig.traco.priority > 0) || (config->interruptConfig.traco.typeOfService == IfxSrc_Tos_dma0))
#endif
    {
