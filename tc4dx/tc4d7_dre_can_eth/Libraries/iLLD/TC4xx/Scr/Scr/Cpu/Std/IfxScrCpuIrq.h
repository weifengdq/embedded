...
IFX_INLINE uint8 IfxScrCpuIrq_readMessageFromTricore(void)
{
    ...
    SCR_SCUSCR_PAGE.U = (SCR_SCUSCR_PAGE.U & (uint8)0xF8U) | (uint8)(0x01);
    ...
    {}
    return (uint8)SCR_SCUSCR_TCINTEXCHG.U;
}
...
IFX_INLINE void IfxScrCpuIrq_sendMessageToTricore(uint8 messageToTricore)
{
    ...
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x1))
    {}
    SCR_SCUSCR_SCRINTEXCHG.U = messageToTricore;
}
...
IFX_INLINE void IfxScrCpuIrq_triggerTricoreInterrupt(uint8 messageToTricore, IfxScrCpuIrq_ScrInterrupt intp)
{
    ...
    SCR_IRSCR_PAGE.U = (SCR_IRSCR_PAGE.U & (uint8)0xF8U) | (uint8)(0x01);

    while ((SCR_IRSCR_NMICON.U & (uint8)(1u << IFX_SCR_IRSCR_NMICON_SCRINTTC0_OFF)))
    {}
    ...
    {
        SCR_IRSCR_NMICON.U = (SCR_IRSCR_NMICON.U | (uint8)(1u << IFX_SCR_IRSCR_NMICON_SCRINTTC0_OFF));
    }
    else
    {
        SCR_IRSCR_NMICON.U = (SCR_IRSCR_NMICON.U | (uint8)(1u << IFX_SCR_IRSCR_NMICON_SCRINTTC1_OFF));
    }
}
...
IFX_INLINE void IfxScrCpuIrq_enableNmi(IfxScrCpuIrq_NmiSource nmiSource)
{
    ...
    SCR_SYSCON0.U   = SCR_SYSCON0.U & (uint8)(0xFE);
    SCR_IRSCR_PAGE.U   = (SCR_IRSCR_PAGE.U & (uint8)0xF8U) | (uint8)(0x01);
    SCR_IRSCR_NMICON.U = (SCR_IRSCR_NMICON.U | ((uint8)1U << nmiSource));
}
...
IFX_INLINE boolean IfxScrCpuIrq_isNmiSourceEnabled(IfxScrCpuIrq_NmiSource nmiSource)
{
    ...
    SCR_SYSCON0.U = SCR_SYSCON0.U & (uint8)(0xFE);
    SCR_IRSCR_PAGE.U = (SCR_IRSCR_PAGE.U & (uint8)0xF8U) | (uint8)(0x01);
    status        = (boolean)((SCR_IRSCR_NMICON.U & (1 << nmiSource)) >> nmiSource);
    return status;
}
...
IFX_INLINE boolean IfxScrCpuIrq_getNmiStatus(IfxScrCpuIrq_NmiSource nmiSource)
{
    ...
    SCR_SYSCON0.U = SCR_SYSCON0.U & (uint8)(0xFE);
    SCR_IRSCR_PAGE.U = (SCR_IRSCR_PAGE.U & (uint8)0xF8U) | (uint8)(0x01);
    status        = (boolean)((SCR_IRSCR_NMISTAT.U & (1 << nmiSource)) >> nmiSource);
    return status;
}
...
IFX_INLINE void IfxScrCpuIrq_clearNmiInterruptFlag(IfxScrCpuIrq_NmiSource nmiSource)
{
    SCR_SYSCON0.U    = SCR_SYSCON0.U & (uint8)(0xFE);
    SCR_IRSCR_PAGE.U    = (SCR_IRSCR_PAGE.U & (uint8)0xF8U) | (uint8)(0x01);
    SCR_IRSCR_NMISTAT.U = (SCR_IRSCR_NMISTAT.U & (uint8)(~(1 << nmiSource)));
}
...
IFX_INLINE boolean IfxScrCpuIrq_getExternalInterruptStatus(IfxScrCpuIrq_ExternalInterrupt externalInterrupt)
{
    boolean status = FALSE;
    SCR_SYSCON0.U = SCR_SYSCON0.U & (uint8)(0xFE);
    SCR_IRSCR_PAGE.U = (SCR_IRSCR_PAGE.U & (uint8)0xF8U);
    ...
    {
        status = (boolean)((SCR_IRSCR_CON0.U & (1u << externalInterrupt)) >> externalInterrupt);
    }
    else
    {
        status = (boolean)((SCR_IRSCR_CON2.U & (1u << (externalInterrupt - IfxScrCpuIrq_ExternalInterrupt_8))) >> (externalInterrupt - IfxScrCpuIrq_ExternalInterrupt_8));
    }
...
IFX_INLINE void IfxScrCpuIrq_clearExternalInterruptFlag(IfxScrCpuIrq_ExternalInterrupt externalInterrupt)
{
    ...
    {
        SCR_IRSCR_CON0.U = (SCR_IRSCR_CON0.U & (uint8)~(1u << externalInterrupt));
    }
    else
    {
        SCR_IRSCR_CON2.U = (SCR_IRSCR_CON2.U & (uint8)~(1u << (externalInterrupt - IfxScrCpuIrq_ExternalInterrupt_8)));
    }
}
...
IFX_INLINE void IfxScrCpuIrq_setExternalInterruptTriggerEdgeType(IfxScrCpuIrq_ExternalInterrupt externalInterrupt, IfxScrCpuIrq_ExternalInterruptTriggerEdge triggerEdgeType)
{
    ...
    {
        SCR_IRSCR_PAGE.U    = (SCR_IRSCR_PAGE.U & (uint8)0xF8U) | (uint8)(0x02u);
        SCR_IRSCR_EXICON0.U = (SCR_IRSCR_EXICON0.U & (uint8)(~(IFX_SCR_IRSCR_EXICON0_EXINT0_MSK << (externalInterrupt * 2u)))) | (uint8)(triggerEdgeType << (externalInterrupt * 2u));
    }
    else if (externalInterrupt <= IfxScrCpuIrq_ExternalInterrupt_7)
    {
        SCR_IRSCR_PAGE.U    = (SCR_IRSCR_PAGE.U & (uint8)0xF8U) | (uint8)(0x02u);
        SCR_IRSCR_EXICON1.U = (SCR_IRSCR_EXICON1.U & (uint8)(~(IFX_SCR_IRSCR_EXICON1_EXINT4_MSK << ((externalInterrupt - IfxScrCpuIrq_ExternalInterrupt_4) * 2u)))) | (uint8)(triggerEdgeType << ((externalInterrupt - IfxScrCpuIrq_ExternalInterrupt_4) * 2u));
    }
    else if (externalInterrupt <= IfxScrCpuIrq_ExternalInterrupt_11)
    {
        SCR_IRSCR_PAGE.U    = (SCR_IRSCR_PAGE.U & (uint8)0xF8U) | (uint8)(0x02u);
        SCR_IRSCR_EXICON2.U = (SCR_IRSCR_EXICON2.U & (uint8)(~(IFX_SCR_IRSCR_EXICON2_EXINT8_MSK << ((externalInterrupt - IfxScrCpuIrq_ExternalInterrupt_8) * 2u)))) | (uint8)(triggerEdgeType << ((externalInterrupt - IfxScrCpuIrq_ExternalInterrupt_8) * 2u));
    }
    else
    {
        SCR_IRSCR_PAGE.U    = (SCR_IRSCR_PAGE.U & (uint8)0xF8U) | (uint8)(0x03u);
        SCR_IRSCR_EXICON3.U = (SCR_IRSCR_EXICON3.U & (uint8)(~(IFX_SCR_IRSCR_EXICON3_EXINT12_MSK << ((externalInterrupt - IfxScrCpuIrq_ExternalInterrupt_12) * 2u)))) | (uint8)(triggerEdgeType << ((externalInterrupt - IfxScrCpuIrq_ExternalInterrupt_12) * 2u));
    }
}
...
IFX_INLINE void IfxScrCpuIrq_selectExternalInterruptInput(IfxScrCpuIrq_ExternalInterrupt externalInterrupt, IfxScrCpuIrq_ExternalInterruptInput input)
{
    ...
    {
        SCR_IRSCR_PAGE.U    = (SCR_IRSCR_PAGE.U & (uint8)0xF8U) | (uint8)(0x04u);
        shift           = ((externalInterrupt * 2u) + 2u);
        SCR_IRSCR_PISEL0.U = (SCR_IRSCR_PISEL0.U & (uint8)(~(IFX_SCR_IRSCR_PISEL0_EXINT0IS_MSK << shift))) | (uint8)(input << shift);
    }
    else if (externalInterrupt <= IfxScrCpuIrq_ExternalInterrupt_6)
    {
    	...
    	SCR_IRSCR_PISEL1.U = (SCR_IRSCR_PISEL1.U & (uint8)(~(IFX_SCR_IRSCR_PISEL1_EXINT3_T2CCU0CH0_IS_MSK << shift))) | (uint8)(input << shift);
    }
    else if (externalInterrupt <= IfxScrCpuIrq_ExternalInterrupt_11)
    {
    	if(externalInterrupt != IfxScrCpuIrq_ExternalInterrupt_7)
    	{
        	...
        	SCR_IRSCR_PISEL2.U = (SCR_IRSCR_PISEL2.U & (uint8)(~(IFX_SCR_IRSCR_PISEL2_EXINT8_T2CCU1CH0_IS_MSK << shift))) | (uint8)(input << shift);
    	}
    	else
    	{
    ...
    else
    {
    	...
    	SCR_IRSCR_PAGE.U    = (SCR_IRSCR_PAGE.U & (uint8)0xF8U) | (uint8)(0x05u);
    	shift            = ((externalInterrupt - IfxScrCpuIrq_ExternalInterrupt_12) * 2u);
    	SCR_IRSCR_PISEL3.U = (SCR_IRSCR_PISEL3.U & (uint8)(~(IFX_SCR_IRSCR_PISEL3_EXINT12IS_MSK << shift))) | (uint8)(input << shift);
    }
}
...
IFX_INLINE boolean IfxScrCpuIrq_getSscInterruptStatus(IfxScrCpuIrq_SscInterrupt sscInterrupt)
{
    ...
    SCR_SYSCON0.U = SCR_SYSCON0.U & (uint8)(0xFEU);
    SCR_IRSCR_PAGE.U = (SCR_IRSCR_PAGE.U & (uint8)0xF8U);
    status        = ((SCR_IRSCR_CON1.U & (uint8)(1u << sscInterrupt)) >> sscInterrupt);
    return status;
}
...
IFX_INLINE void IfxScrCpuIrq_clearSscInterruptFlag(IfxScrCpuIrq_SscInterrupt sscInterrupt)
{
    SCR_SYSCON0.U = SCR_SYSCON0.U & (uint8)(0xFEU);
    SCR_IRSCR_PAGE.U = (SCR_IRSCR_PAGE.U & (uint8)0xF8U);
    SCR_IRSCR_CON1.U = (SCR_IRSCR_CON1.U & ~(1u << sscInterrupt));
}
...
IFX_INLINE void IfxScrCpuIrq_enableDisableSscInterruptSource(IfxScrCpuIrq_SscInterrupt sscInterrupt, IfxScrCpuIrq_Interrupts enable)
{
    SCR_SYSCON0.U   = (SCR_SYSCON0.U & (uint8)(0xFE));
    SCR_IRSCR_PAGE.U   = (SCR_IRSCR_PAGE.U & (uint8)0xF8U) | (uint8)(0x01);
    SCR_IRSCR_MODIEN.U = (SCR_IRSCR_MODIEN.U & (uint8)(~(1 << sscInterrupt))) | (uint8)(enable << sscInterrupt);
}
...
IFX_INLINE boolean IfxScrCpuIrq_isSscInterruptSourceEnabled(IfxScrCpuIrq_SscInterrupt sscInterrupt)
{
    ...
    SCR_SYSCON0.U = SCR_SYSCON0.U & (uint8)(0xFE);
    SCR_IRSCR_PAGE.U = ((SCR_IRSCR_PAGE.U & (uint8)0xF8U) | (uint8)0x01);
    status        = (uint8)((SCR_IRSCR_MODIEN.U & (uint8)(1u << sscInterrupt)) >> sscInterrupt);
    return status;
}
...
IFX_INLINE void IfxScrCpuIrq_enableDisableAdcCompInterrupt(IfxScrCpuIrq_Interrupts enable)
{
    SCR_SYSCON0.U   = (SCR_SYSCON0.U & (uint8)(0xFE));
    SCR_IRSCR_PAGE.U   = (SCR_IRSCR_PAGE.U & (uint8)0xF8U) | (uint8)(0x01);
    SCR_IRSCR_MODIEN.U = (SCR_IRSCR_MODIEN.U & (uint8)(~(1 << IFX_SCR_IRSCR_MODIEN_ADCIEN_OFF))) | (uint8)(enable << IFX_SCR_IRSCR_MODIEN_ADCIEN_OFF);
}
...
IFX_INLINE boolean IfxScrCpuIrq_isAdcCompInterruptEnabled(void)
{
    ...
    SCR_SYSCON0.U = SCR_SYSCON0.U & (uint8)(0xFE);
    SCR_IRSCR_PAGE.U = ((SCR_IRSCR_PAGE.U & (uint8)0xF8U) | (uint8)0x01);
    status        = (uint8)((SCR_IRSCR_MODIEN.U & (uint8)(1u << IFX_SCR_IRSCR_MODIEN_ADCIEN_OFF)) >> IFX_SCR_IRSCR_MODIEN_ADCIEN_OFF);
    return status;
}
...
IFX_INLINE void IfxScrCpuIrq_enableDisableRtcCompareInterrupt(IfxScrCpuIrq_RtcComparator cmp, IfxScrCpuIrq_Interrupts enable)
{
    ...
    {
        SCR_IRSCR_MODIEN.U = (SCR_IRSCR_MODIEN.U & (uint8)(~(1 << IFX_SCR_IRSCR_MODIEN_CMP0IEN_OFF))) | (uint8)(enable << IFX_SCR_IRSCR_MODIEN_CMP0IEN_OFF);
    }
    else
    {
        SCR_IRSCR_MODIEN.U = (SCR_IRSCR_MODIEN.U & (uint8)(~(1 << IFX_SCR_IRSCR_MODIEN_CMP1IEN_OFF))) | (uint8)(enable << IFX_SCR_IRSCR_MODIEN_CMP1IEN_OFF);
    }
}
...
IFX_INLINE void IfxScrCpuIrq_clearRtcCompareInterruptFlag(IfxScrCpuIrq_RtcComparator cmp)
{
    ...
    if(cmp == IfxScrCpuIrq_RtcComparator_0)
    {
    	SCR_IRSCR_CON1.B.CMP0IR = 0U;
    }
    else
    {
    	SCR_IRSCR_CON1.B.CMP1IR = 0U;
    }
}
