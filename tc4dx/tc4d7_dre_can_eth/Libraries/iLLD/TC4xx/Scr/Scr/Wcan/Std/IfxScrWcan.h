 ...
 *
 * \defgroup IfxLld_Scr_Wcan WCAN
 * \ingroup IfxLld_Scr
 * \defgroup IfxLld_Scr_Wcan_Enumerations Enumerations
 * \ingroup IfxLld_Scr_Wcan
 * \defgroup IfxLld_Scr_Wcan_DataStructures Data structures
 * \ingroup IfxLld_Scr_Wcan
 * \defgroup IfxLld_Scr_Wcan_config WCAN Configuration Functionality
 * \ingroup IfxLld_Scr_Wcan
 * \defgroup IfxLld_Scr_Wcan_init WCAN Initialization Functionality
 * \ingroup IfxLld_Scr_Wcan
 *
 */
...
/** \addtogroup IfxLld_Scr_Wcan_Enumerations
 * \{ */
...
/** \addtogroup IfxLld_Scr_Wcan_DataStructures
 * \{ */
...
/** \addtogroup IfxLld_Scr_Wcan_config
 * \{ */
