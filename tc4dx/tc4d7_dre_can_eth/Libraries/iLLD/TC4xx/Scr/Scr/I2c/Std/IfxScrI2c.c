...
void IfxScrI2c_init(IfxScrI2c_Config *i2cConfig)
{
    ...
    /* 2. Select baudrate */
    SCR_I2CSCR_BRCR.U = (i2cConfig->baudRate.preScaler << IFX_SCR_I2CSCR_BRCR_BRP_OFF) | (i2cConfig->baudRate.predivider);
...
IfxScrI2c_Status IfxScrI2c_masterSendData(uint8 *txbuffer, uint16 len, uint16 slaveAddress)
{
    ...
    {
        SCR_I2CSCR_DATA.U = txbuffer[index];
