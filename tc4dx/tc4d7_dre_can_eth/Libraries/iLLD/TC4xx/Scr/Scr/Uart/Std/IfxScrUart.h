 ...
 *
 * \defgroup IfxLld_Scr_Uart UART
 * \ingroup IfxLld_Scr
 * \defgroup IfxLld_Scr_Uart_Enumerations Enum
 * \ingroup IfxLld_Scr_Uart
 * \defgroup IfxLld_Scr_Uart_DataStructures Data structures
 * \ingroup IfxLld_Scr_Uart
 * \defgroup IfxLld_Scr_Uart_TxFunctionality Tx Functionality
 * \ingroup IfxLld_Scr_Uart
 * \defgroup IfxLld_Scr_Uart_RxFunctionality Rx Functionality
 * \ingroup IfxLld_Scr_Uart
 * \defgroup IfxLld_Scr_Uart_init UART Initialization Functionality
 * \ingroup IfxLld_Scr_Uart
 * \defgroup IfxLld_Scr_Uart_LinFunctionality Lin Functionality
 * \ingroup IfxLld_Scr_Uart
 */
...
/*-------------------------------Enumerations---------------------------------*/
/******************************************************************************/
/** \addtogroup IfxLld_Scr_Uart_Enumerations
 * \{ */
...
/** \addtogroup IfxLld_Scr_Uart_DataStructures
 * \{ */
...
/** \addtogroup IfxLld_Scr_Uart_TxFunctionality
 * \{ */
...
/** \addtogroup IfxLld_Scr_Uart_RxFunctionality
 * \{ */
/******************************************************************************/
/*-------------------------Inline Function Prototypes-------------------------*/
/******************************************************************************/
...
/** \addtogroup IfxLld_Scr_Uart_LinFunctionality
 * \{ */
/******************************************************************************/
/*-------------------------Inline Function Prototypes-------------------------*/
/******************************************************************************/
...
/** \addtogroup IfxLld_Scr_Uart_init
 * \{ */
/******************************************************************************/
/*-------------------------Global Function Prototypes-------------------------*/
/******************************************************************************/
...
{
    /*SCU_PAGE = 2*/
    SCR_SCUSCR_PAGE.U      = ((SCR_SCUSCR_PAGE.U & (uint8)(0xF8)) | (uint8)(0x2));
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x2))
    {}
    SCR_SCUSCR_MODPISEL0.U = ((SCR_SCUSCR_MODPISEL0.U & ~(IFX_SCR_SCUSCR_MODPISEL0_URRIS_MSK << IFX_SCR_SCUSCR_MODPISEL0_URRIS_OFF)) | rxd);
}
