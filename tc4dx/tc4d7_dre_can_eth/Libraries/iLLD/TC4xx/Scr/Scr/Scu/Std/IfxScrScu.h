...
{
    boolean source = 0;
    SCR_SCUSCR_PAGE.U = (SCR_SCUSCR_PAGE.U & (0xF8U));
     ...
     */
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x0))
    {}

    if ((SCR_SCUSCR_CLK.B.DIV_STAT & (0xFU)) == 0xFu)
    {
        source = FALSE;
    }
    else
...
IFX_INLINE IfxScrScu_DivideFactor IfxScrScu_getClockDivider(void)
{
    ...
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x0))
    {}
    return (IfxScrScu_DivideFactor)((SCR_SCUSCR_CLK.U & (0xFu << IFX_SCR_SCUSCR_CLK_DIV_STAT_OFF)) >> IFX_SCR_SCUSCR_CLK_DIV_STAT_OFF);
}
...
IFX_INLINE void IfxScrScu_setClockDivider(IfxScrScu_DivideFactor divider)
{
    ...
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x0))
    {}
    SCR_SCUSCR_CLK.U  = ((SCR_SCUSCR_CLK.U & (0xFu << IFX_SCR_SCUSCR_CLK_DIV_STAT_OFF)) | divider);
...
IFX_INLINE void IfxScrScu_restorePageValue(void)
{
    SCR_SCUSCR_PAGE.U = (SCR_SCUSCR_PAGE.U & 0x3FU) | (3U << IFX_SCR_PAGE_OP_OFF);
}


IFX_INLINE void IfxScrScu_enableAutoSavePageValue(void)
{
    SCR_SCUSCR_PAGE.U = (SCR_SCUSCR_PAGE.U & 0x3FU) | (2U << IFX_SCR_PAGE_OP_OFF);
}


IFX_INLINE void IfxScrScu_selectPageStorageRegisters(IfxScrScu_StorageNumber stnr)
{
    SCR_SCUSCR_PAGE.U = (SCR_SCUSCR_PAGE.U & 0xCFU) | (stnr << IFX_SCR_PAGE_STNR_OFF);
}
...
IFX_INLINE void IfxScrScu_enableDisableGeneratedInterrupt(IfxScrScu_GeneratedReset generatedReset, Ifx_Functionality enable)
{
    ...
    if (generatedReset == IfxScrScu_GeneratedReset_software)
    {
        ...
        SCR_SCUSCR_RSTCON.U = (SCR_SCUSCR_RSTCON.U & ~(1 << generatedReset)) | (enable << generatedReset);
...
IFX_INLINE void IfxScrScu_enableGeneratedReset(IfxScrScu_GeneratedReset generatedReset)
{
    SCR_SCUSCR_PAGE.U = (SCR_SCUSCR_PAGE.U & (uint8)0xF8U);
    /* TOCHECK : Waiting for the page bit to update is really needed.
     * In RTL the page value was not updated and and writing to SCRINTEXCHG caused an unexpected reset(RSTCON).
     */
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x0))
    ...
    if (generatedReset == IfxScrScu_GeneratedReset_software)
    {
        /* Enable bit protection write access */
        IfxScrScu_enableBitProtectedWriteAccess();
        SCR_SCUSCR_RSTCON.U = SCR_SCUSCR_RSTCON.U | (1U << generatedReset);
        /* Disable bit protection write access */
        IfxScrScu_disableBitProtectedWriteAccess();
    }
    else
...
IFX_INLINE void IfxScrScu_generateSoftwareReset(void)
{
    ...
    /* Enable bit protection write access */
    IfxScrScu_enableBitProtectedWriteAccess();
    SCR_SCUSCR_RSTCON.U = (SCR_SCUSCR_RSTCON.U | (1u << IFX_SCR_SCUSCR_RSTCON_SWRSTREQ_OFF));
    /* Disable bit protection write access */
...
IFX_INLINE boolean IfxScrScu_hasGeneratedResetOccured(IfxScrScu_GeneratedReset generatedReset)
{
    ...
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x0))
    {}
    return (boolean)((SCR_SCUSCR_RSTSTAT.U & (unsigned char)(1 << generatedReset)) >> generatedReset);
}
...
IFX_INLINE void IfxScrScu_clearGeneratedResetFlag(IfxScrScu_GeneratedReset generatedReset)
{
    if (generatedReset != IfxScrScu_GeneratedReset_software)
    {
        ...
        while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x0))
        {}
        SCR_SCUSCR_RSTSTAT.U = (SCR_SCUSCR_RSTSTAT.U & (unsigned char)(~(1 << generatedReset)));
    }
}
...
IFX_INLINE boolean IfxScrScu_hasMainResetOccured(IfxScrScu_MainReset mainReset)
{
    ...
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x0))
    {}
    return (boolean)((SCR_SCUSCR_MRSTSTAT.U & (unsigned char)(1 << mainReset)) >> mainReset);
}
...
IFX_INLINE void IfxScrScu_clearMainResetFlag(IfxScrScu_MainReset mainReset)
{
    ...
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x0))
    {}
    SCR_SCUSCR_MRSTSTAT.U = (SCR_SCUSCR_MRSTSTAT.U & (unsigned char)(~(1 << mainReset)));
}
...
IFX_INLINE void IfxScrScu_disableModule(IfxScrScu_Module module)
{
    SCR_SCUSCR_PAGE.U = ((SCR_SCUSCR_PAGE.U & (0xF8U)) | (uint8)1U);
    /* TOCHECK : Waiting for the page bit to update is really needed.
     * In RTL the page value was not updated and and writing to SCRINTEXCHG caused an unexpected reset(RSTCON).
     */
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x1))
    {}
    if (module < IfxScrScu_Module_i2c)
    {
        SCR_SCUSCR_PMCON0.U = (SCR_SCUSCR_PMCON0.U | (1U << module));
    }
    else
    {
        SCR_SCUSCR_PMCON1.U = (SCR_SCUSCR_PMCON1.U | (1U << (module - IfxScrScu_Module_i2c)));
    }
}
...
IFX_INLINE void IfxScrScu_disableAllModules(void)
{
    ...
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x1))
    {}
    SCR_SCUSCR_PMCON0.U = 0xFFU;
    SCR_SCUSCR_PMCON1.U = (1u << IFX_SCR_SCUSCR_PMCON1_I2C_DIS_OFF);
}
...
IFX_INLINE void IfxScrScu_enableModule(IfxScrScu_Module module)
{
    ...
    if (module < IfxScrScu_Module_i2c)
    {
        SCR_SCUSCR_PMCON0.U = (SCR_SCUSCR_PMCON0.U & (uint8)(~(1U << module)));
    }
    else
    {
        SCR_SCUSCR_PMCON1.U = (SCR_SCUSCR_PMCON1.U & (uint8)(~(1U << (module - IfxScrScu_Module_i2c))));
    }
}
...
IFX_INLINE void IfxScrScu_enableAllModules(void)
{
    ...
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x1))
    {}
    SCR_SCUSCR_PMCON0.U = 0U;
    SCR_SCUSCR_PMCON1.U = 0U;
}
...
IFX_INLINE void IfxScrScu_enableTricoreWakeupEvent(IfxScrScu_WakeupEvent event)
{
    ...
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x0))
    {}
    SCR_SCUSCR_WKPCON.U = (SCR_SCUSCR_WKPCON.U | (1U << event));
}
...
IFX_INLINE void IfxScrScu_disableTricoreWakeupEvent(IfxScrScu_WakeupEvent event)
{
    ...
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x0))
    {}
    SCR_SCUSCR_WKPCON.U = (SCR_SCUSCR_WKPCON.U & (uint8)(~(1 << event)));
}
...
IFX_INLINE boolean IfxScrScu_isTricoreInStandby(void)
{
    ...
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x0))
    {}
    return (boolean)((SCR_SCUSCR_STBY.U & (uint8)(1u << IFX_SCR_SCUSCR_STBY_STBYSTAT_OFF)));
}
...
IFX_INLINE boolean IfxScrScu_switchScrMode(IfxScrScu_Mode mode)
{
    ...
    if (SCR_SCUSCR_STBY.U & 0x01)
    {
        if (mode == IfxScrScu_Mode_70kHz)
        {
            ...
            SCR_SCUSCR_CLK.U = ((SCR_SCUSCR_CLK.U & (0xFu << IFX_SCR_SCUSCR_CLK_DIV_STAT_OFF)) | IfxScrScu_DivideFactor_70Khz);

            /*Wait for the clock divider to set */
            while (!(SCR_SCUSCR_CLK.B.DIV_STAT == IfxScrScu_DivideFactor_70Khz))
            {}
        }
        else if (mode == IfxScrScu_Mode_100MHz)
        {
            ...
            if (SCR_SCUSCR_CLK.B.DIV_STAT == IfxScrScu_DivideFactor_70Khz)
            {
                SCR_SCUSCR_CLK.U = ((SCR_SCUSCR_CLK.U & (0xFu << IFX_SCR_SCUSCR_CLK_DIV_STAT_OFF)) | IfxScrScu_DivideFactor_5);

                /*Wait for the clock divider to set */
                while (!(SCR_SCUSCR_CLK.B.DIV_STAT == IfxScrScu_DivideFactor_5))
                {}
            }
        }
        else
...
IFX_INLINE IfxScrScu_Mode IfxScrScu_getScrMode(void)
{
    ...
    else if (!(SCR_SCUSCR_CLK.B.DIV_STAT == IfxScrScu_DivideFactor_70Khz) && (SCR_ADCOMP_CON.U & 0x01))
    {
...
IFX_INLINE void IfxScrScu_serviceWatchdog(unsigned char reloadValue)
{
    SCR_WDTSCR_REL.U = reloadValue;
    SCR_WDTSCR_CON.U = (SCR_WDTSCR_CON.U | (1u << IFX_SCR_WDTSCR_CON_WDTRS_OFF));

    while (SCR_WDTSCR_CON.U & (1u << IFX_SCR_WDTSCR_CON_WDTRS_OFF))  // wait till it's cleared by hardware
    {}
}
...
IFX_INLINE void IfxScrScu_configureWatchdogClock(IfxScrScu_WatchdogClockSource clockSource, IfxScrScu_WatchdogClockDivider divider)
{
    SCR_WDTSCR_CON.U = ((SCR_WDTSCR_CON.U & 0xF6u) | (unsigned char)divider | (unsigned char)(clockSource << IFX_SCR_WDTSCR_CON_WDTCLK_OFF));
}
...
IFX_INLINE void IfxScrScu_enableWatchdog(void)
{
    /*enable bit protection write access*/
    IfxScrScu_enableBitProtectedWriteAccess();
    SCR_WDTSCR_CON.U = (SCR_WDTSCR_CON.U | (1u << IFX_SCR_WDTSCR_CON_WDTEN_OFF));
    /*disable bit protection write access*/
    IfxScrScu_disableBitProtectedWriteAccess();
}
...
IFX_INLINE boolean IfxScrScu_hasWatchdogOverflowOccured(void)
{
    return (boolean)((SCR_WDTSCR_CON.U & (1u << IFX_SCR_WDTSCR_CON_WDTPR_OFF)) >> IFX_SCR_WDTSCR_CON_WDTPR_OFF);
}


IFX_INLINE uint16 IfxScrScu_getWatchdogCounterValue(void)
{
    return (uint16)((SCR_WDTSCR_H.U << 8u) | SCR_WDTSCR_L.U);
}


IFX_INLINE uint8 IfxScrScu_getWatchdogCounterHighValue(void)
{
    return (uint8)(SCR_WDTSCR_H.U);
}


IFX_INLINE void IfxScrScu_enableWatchdogWindowBoundary(void)
{
    SCR_WDTSCR_CON.U = (SCR_WDTSCR_CON.U | 1U << IFX_SCR_WDTSCR_CON_WINBEN_OFF);
}
...
IFX_INLINE void IfxScrScu_setWatchdogWindowBoundaryValue(uint8 boundaryValue)
{
    SCR_WDTSCR_WINB.U = boundaryValue;
}
...
IFX_INLINE void IfxScrScu_configureWatchdogWindowBoundary(Ifx_Functionality enable, unsigned char boundaryValue)
{
    ...
    SCR_WDTSCR_CON.U = ((SCR_WDTSCR_CON.U & ~(1u << IFX_SCR_WDTSCR_CON_WINBEN_OFF)) | enable << IFX_SCR_WDTSCR_CON_WINBEN_OFF);
}


IFX_INLINE void IfxScrScu_refreshWatchdog(void)
{
    SCR_WDTSCR_CON.U |= (1u << IFX_SCR_WDTSCR_CON_WDTRS_OFF);
}


IFX_INLINE boolean IfxScrScu_getWatchdogPrewarningStatus(void)
{
    return (boolean)(SCR_WDTSCR_CON.B.WDTPR);
}
...
IFX_INLINE IfxScrScu_Status IfxScrScu_requestStby1ToStby0Transititon(void)
{
    ...
    if(SCR_SCUSCR_STBY.B.STBYSTAT)
    {
        SCR_SCUSCR_PAGE.U = (SCR_SCUSCR_PAGE.U & (uint8)0xF8U);
        while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x0))
        {}
    	/* Clearing wakeup up flags */
    	SCR_SCUSCR_STBY.B.PMSWKPCLR = 1U;
    	/* Request standby 0 entry */
    	SCR_SCUSCR_STBY.B.STBY0REQ = 1U;
...
IFX_INLINE void IfxScrScu_suspendModule(IfxScrScu_SuspendModule module)
{
	SCR_SCUSCR_PAGE.U         = ((SCR_SCUSCR_PAGE.U & (0xF8U)) | 7U);
	SCR_SCUSCR_DBG_MODSUSP.U  = (1u << module);
}
...
IFX_INLINE IfxScrScu_RtcTImerValue IfxScrScu_readPmsRtcTimer(void)
{
    ...
    SCR_SCUSCR_PAGE.U      = ((SCR_SCUSCR_PAGE.U & (0xF8U)) | 2U);
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x2))
    {}
    timValue.upperPart  = (uint32)SCR_SCUSCR_PMSRTC_TIM39_32.U;
    timValue.upperPart |= (uint32)((uint32)SCR_SCUSCR_PMSRTC_TIM47_40.U << 8u);
    timValue.upperPart |= (uint32)((uint32)SCR_SCUSCR_PMSRTC_TIM55_48.U << 16u);
    timValue.upperPart |= (uint32)((uint32)SCR_SCUSCR_PMSRTC_TIM63_56.U << 24u);

    SCR_SCUSCR_PAGE.U      = ((SCR_SCUSCR_PAGE.U & (0xF8U)) | 3U);
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x3))
    {}
    timValue.lowerPart  = (uint32)SCR_SCUSCR_PMSRTC_TIM7_0.U;
    timValue.lowerPart |= (uint32)((uint32)SCR_SCUSCR_PMSRTC_TIM15_8.U << 8u);
    timValue.lowerPart |= (uint32)((uint32)SCR_SCUSCR_PMSRTC_TIM23_16.U << 16u);
    timValue.lowerPart |= (uint32)((uint32)SCR_SCUSCR_PMSRTC_TIM31_24.U << 24u);
    return timValue;
}
...
IFX_INLINE void IfxScrScu_setPmsRtcOffset(uint16 offsetValue)
{
    ...
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x3))
    {}
    SCR_SCUSCR_PMSRTC_OFFSET15_8.U = (uint8)(offsetValue >> 8u);
    SCR_SCUSCR_PMSRTC_OFFSET7_0.U  = (uint8)(offsetValue);
}


IFX_INLINE void IfxScrScu_setPmsRtcCompareValue(uint32 cmpValue)
{
    SCR_SCUSCR_PAGE.U               = ((SCR_SCUSCR_PAGE.U & (0xF8U)) | 4U);
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x4))
    {}
    SCR_SCUSCR_PMSRTC_CMP1_31_24.U  = (uint8)(cmpValue >> 24u);
    SCR_SCUSCR_PMSRTC_CMP1_23_16.U |= (uint8)(cmpValue >> 16u);
    SCR_SCUSCR_PMSRTC_CMP1_15_8.U  |= (uint8)(cmpValue >> 8u);
    SCR_SCUSCR_PMSRTC_CMP1_7_0.U   |= (uint8)(cmpValue);
}
...
IFX_INLINE void IfxScrScu_setPmsRtcMsizeValue(uint8 value)
{
    ...
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x4))
    {}
    SCR_SCUSCR_PMSRTC_MSIZE1.U = (uint8)(value & IFX_SCR_SCUSCR_PMSRTC_MSIZE1_VAL_MSK);
}
...
IFX_INLINE void IfxScrScu_setPmsRtcMstartValue(uint8 value)
{
    ...
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x4))
    {}
    SCR_SCUSCR_PMSRTC_MSTART1.U = (uint8)(value & IFX_SCR_SCUSCR_PMSRTC_MSTART1_VAL_MSK);
}


IFX_INLINE void IfxScrScu_enablePmsDts(void)
{
    SCR_SCUSCR_PAGE.U        = ((SCR_SCUSCR_PAGE.U & (0xF8U)) | 5U);
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x5))
    {}
    SCR_SCUSCR_PMSDTS_CON.U |= (1u << IFX_SCR_SCUSCR_PMSDTS_CON_EN_START_OFF);
}
...
IFX_INLINE boolean IfxScrScu_isPmsDtsEnabled(void)
{
    ...
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x5))
    {}
    return (boolean)(SCR_SCUSCR_PMSDTS_RES11_8.B.RES_READY);
}
...
IFX_INLINE uint16 IfxScrScu_readPmsDtsValue(void)
{
    ...
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x5))
    {}
    resh1          = SCR_SCUSCR_PMSDTS_RES11_8.B.VAL;
    resl1          = SCR_SCUSCR_PMSDTS_RES7_0.U;
    resh2          = SCR_SCUSCR_PMSDTS_RES11_8.B.VAL;
    resl2          = SCR_SCUSCR_PMSDTS_RES7_0.U;
