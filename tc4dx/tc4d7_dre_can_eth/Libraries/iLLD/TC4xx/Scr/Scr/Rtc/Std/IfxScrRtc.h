 ...
 *
 * \defgroup IfxLld_Scr_Rtc RTC
 * \ingroup IfxLld_Scr
 * \defgroup IfxLld_Scr_Rtc_Enumerations Enum
 * \ingroup IfxLld_Scr_Rtc
 * \defgroup IfxLld_Scr_Rtc_DataStructures Data structures
 * \ingroup IfxLld_Scr_Rtc
 * \defgroup IfxLld_Scr_Rtc RTC Functionality
 * \ingroup IfxLld_Scr_Rtc
 * \defgroup IfxLld_Scr_Rtc_init RTC init Functionality
 * \ingroup IfxLld_Scr_Rtc
 */
...
/*-------------------------------Enumerations---------------------------------*/
/******************************************************************************/
/** \addtogroup IfxLld_Scr_Rtc_Enumerations
 * \{ */
...
/*-----------------------------Data Structures--------------------------------*/
/******************************************************************************/
/** \addtogroup IfxLld_Scr_Rtc_DataStructures
 * \{ */
...
/** \brief Disables the Real-Time Clock (RTC) functionality.
 *	After being written to RTC_CON.RTCC, it
 *	takes 6 RTC Clock cycles for the RTC to be actually enabled or disabled
 * \return None
 */
...
/******************************************************************************/
/** \addtogroup IfxLld_Scr_Rtc_init
 * \{ */
...
IFX_INLINE void IfxScrRtc_enableRtc(void)
{
    ...
    SCR_RTCSCR_CON.U = (SCR_RTCSCR_CON.U | 1U);
}
...
IFX_INLINE boolean IfxScrRtc_selectClockSource(IfxScrRtc_ClockSel clockSource)
{
    ...
    if (!(SCR_RTCSCR_CON.U & (1u << IFX_SCR_RTCSCR_CON_RTCC_OFF)))
    {
        rtc_con.U     = (SCR_RTCSCR_CON.U & ~(IFX_SCR_RTCSCR_CON_RTCCLKSEL_MSK << IFX_SCR_RTCSCR_CON_RTCCLKSEL_OFF));
        rtc_con.U    |= (clockSource << IFX_SCR_RTCSCR_CON_RTCCLKSEL_OFF) | (1u << IFX_SCR_RTCSCR_CON_RTCCLKSEL_P_OFF);
...
/* Loading the 32-bit initial count value */
    SCR_RTCSCR_CNT0.U = (uint8)initialValue;
    SCR_RTCSCR_CNT1.U = (uint8)(initialValue >> 8);
    SCR_RTCSCR_CNT2.U = (uint8)(initialValue >> 16);
    SCR_RTCSCR_CNT3.U = (uint8)(initialValue >> 24);
...
{
    SCR_SYSCON0.U = SCR_SYSCON0.U & (uint8)(0xFE);
    SCR_RTCSCR_CR0.U = (uint8)compareValue;
    SCR_RTCSCR_CR1.U = (uint8)(compareValue >> 8);
    SCR_RTCSCR_CR2.U = (uint8)(compareValue >> 16);
    SCR_RTCSCR_CR3.U = (uint8)(compareValue >> 24);
}
...
{
    SCR_SYSCON0.U  = SCR_SYSCON0.U & (uint8)(0xFE);
    SCR_RTCSCR_CON.U |= (1u << IFX_SCR_RTCSCR_CON_RTPBYP_OFF);
}
...
{
    SCR_SYSCON0.U = SCR_SYSCON0.U & (uint8)(0xFE);
    SCR_RTCSCR_CON.U = (SCR_RTCSCR_CON.U | (1u << IFX_SCR_RTCSCR_CON_RTCCT_OFF));

    while ((SCR_RTCSCR_CON.U & (1u << IFX_SCR_RTCSCR_CON_RTCCT_OFF)) != 0U)
    {}
}
...
{
    SCR_SYSCON0.U = SCR_SYSCON0.U & (uint8)(0xFE);
    SCR_RTCSCR_CON.U = SCR_RTCSCR_CON.U & ~(1u << IFX_SCR_RTCSCR_CON_CFRTC_OFF);
}
...
{
    SCR_SYSCON0.U = SCR_SYSCON0.U & (uint8)(0xFE);
    SCR_RTCSCR_CON.U = SCR_RTCSCR_CON.U | (1u << IFX_SCR_RTCSCR_CON_ECRTC_OFF);
}
...
IFX_INLINE boolean IfxScrRtc_isCompareInterruptEnabled(void)
{
    return (boolean)((SCR_RTCSCR_CON.U & (1u << IFX_SCR_RTCSCR_CON_ECRTC_OFF)) >> IFX_SCR_RTCSCR_CON_ECRTC_OFF);
}


IFX_INLINE boolean IfxScrRtc_isCompareInterruptOccured(void)
{
    return (boolean)((SCR_RTCSCR_CON.U & (1u << IFX_SCR_RTCSCR_CON_CFRTC_OFF)) >> IFX_SCR_RTCSCR_CON_CFRTC_OFF);
}
...
IFX_INLINE uint32 IfxScrRtc_readCaptureValue(void)
{
    ...
    SCR_SYSCON0.U = SCR_SYSCON0.U & (uint8)(0xFE);
    captureValue |= ((uint32)SCR_RTCSCR_CR0.U);
    captureValue |= ((uint32)SCR_RTCSCR_CR1.U << 8);
    captureValue |= ((uint32)SCR_RTCSCR_CR2.U << 16);
    captureValue |= ((uint32)SCR_RTCSCR_CR3.U << 24);
...
IFX_INLINE uint32 IfxScrRtc_readTimerValue(void)
{
	...
	tval  = (uint32)SCR_RTCSCR_CNT0.U;
	tval |= (uint32)SCR_RTCSCR_CNT1.U << 8u;
	tval |= (uint32)SCR_RTCSCR_CNT2.U << 16u;
	tval |= (uint32)SCR_RTCSCR_CNT3.U << 24u;
