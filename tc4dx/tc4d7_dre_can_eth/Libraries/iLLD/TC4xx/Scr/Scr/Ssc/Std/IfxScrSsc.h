 ...
 *
 *  \endcode
 * \defgroup IfxLld_Scr_Ssc SSC
 * \ingroup IfxLld_Scr
 * \defgroup IfxLld_Scr_Ssc_Enumerations Enums
 * \ingroup IfxLld_Scr_Ssc
 * \defgroup IfxLld_Scr_Ssc_DataStructures Data structures
 * \ingroup IfxLld_Scr_Ssc
 * \defgroup IfxLld_Scr_Ssc_TxFunctionality Tx Functionality
 * \ingroup IfxLld_Scr_Ssc
 * \defgroup IfxLld_Scr_Ssc_RxFunctionality Rx Functionality
 * \ingroup IfxLld_Scr_Ssc
 * \defgroup IfxLld_Scr_Ssc_init SSC Initialization Functionality
 * \ingroup IfxLld_Scr_Ssc
 *
 */
...
/** \addtogroup IfxLld_Scr_Ssc_Enumerations
 * \{ */
...
/** \addtogroup IfxLld_Scr_Ssc_DataStructures
 * \{ */
...
/** \addtogroup IfxLld_Scr_Ssc_init
 * \{ */
...
/** \addtogroup IfxLld_Scr_Ssc_TxFunctionality
 * \{ */
...
/** \addtogroup IfxLld_Scr_Ssc_RxFunctionality
 * \{ */
...
IFX_INLINE void IfxScrSsc_initModule(IfxScrSsc_Config *sscConfig)
{
    ...
    SCR_IRSCR_MODIEN.U = (sscConfig->enableTransmitErrorInterrupt | (sscConfig->enableReceiveErrorInterrupt | sscConfig->enableBaudrateErrorInterrupt) | (sscConfig->enableTransmitBufferReadyInterrupt << IFX_SCR_IRSCR_MODIEN_TIREN_OFF) | (sscConfig->enableDataReceivedInterrupt << IFX_SCR_IRSCR_MODIEN_RIREN_OFF) | (sscConfig->enableReceiveFifoEmptyInterrupt << IFX_SCR_IRSCR_MODIEN_RFEIEN_OFF) | (sscConfig->enableReceiveFifoFullInterrupt << IFX_SCR_IRSCR_MODIEN_RFFIEN_OFF));
...
IFX_INLINE void IfxScrSsc_setMasterModeRxInput(IfxScrSsc_InputSel input)
{
    SCR_SCUSCR_PAGE.U      = (SCR_SCUSCR_PAGE.U & (uint8)0xF8U) | (uint8)(0x02);
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x2))
    {}
    SCR_SCUSCR_MODPISEL1.U = ((SCR_SCUSCR_MODPISEL1.U & ~(IFX_SCR_SCUSCR_MODPISEL1_MIS_MSK << IFX_SCR_SCUSCR_MODPISEL1_MIS_OFF)) | \
                           (uint8)(input << IFX_SCR_SCUSCR_MODPISEL1_MIS_OFF));
}
...
IFX_INLINE void IfxScrSsc_setSlaveModeRxInput(IfxScrSsc_InputSel input)
{
    ...
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x2))
    {}
    SCR_SCUSCR_MODPISEL1.U = ((SCR_SCUSCR_MODPISEL1.U & ~(IFX_SCR_SCUSCR_MODPISEL1_SIS_MSK << IFX_SCR_SCUSCR_MODPISEL1_SIS_OFF)) | \
                           (uint8)(input << IFX_SCR_SCUSCR_MODPISEL1_SIS_OFF));
}
...
IFX_INLINE void IfxScrSsc_setSlaveModeClockInput(IfxScrSsc_InputSel input)
{
    ...
    while(!(SCR_SCUSCR_PAGE.B.PAGE == 0x2))
    {}
    SCR_SCUSCR_MODPISEL1.U = ((SCR_SCUSCR_MODPISEL1.U & ~(uint8)(IFX_SCR_SCUSCR_MODPISEL1_CIS_MSK << IFX_SCR_SCUSCR_MODPISEL1_CIS_OFF)) | \
                           (uint8)(input << IFX_SCR_SCUSCR_MODPISEL1_CIS_OFF));
}
...
IFX_INLINE boolean IfxScrSsc_isTransmitBufferReady(void)
{
    ...
    return (boolean)((SCR_IRSCR_CON1.U & (1u << IFX_SCR_IRSCR_CON1_TIR_OFF)) >> IFX_SCR_IRSCR_CON1_TIR_OFF);
}
...
{
    SCR_IRSCR_PAGE.U = SCR_IRSCR_PAGE.U & (uint8)0xF8U;
    SCR_IRSCR_CON1.U = SCR_IRSCR_CON1.U & ~(1u << IFX_SCR_IRSCR_CON1_TIR_OFF);
}
