 ...
 *
 *  //NOTE When timestamp is enabled, groups must contain at most 7 channels and all channels must belong
 *  //to the same AW2 sub-block (0-6, 7-13, or 14-15) to avoid accessing reserved memory regions present in AW2.
 *
