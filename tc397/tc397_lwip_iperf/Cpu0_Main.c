/**********************************************************************************************************************
 * \file Cpu0_Main.c
 * \brief TC397 GETH RGMII (YT8011AN) + lwIP iperf + Letter-Shell (ASCLIN0 P14.0/14.1 921600) + P13.0 LED.
 * Ported from tc387_2 (RTL8211F) — PHY replaced by YT8011AN, UART4 -> UART0, P00.5 -> P13.0.
...
void core0_main (void)
{
    ...
    Shell_PrintBanner();
    {
        ...
        Ifx_SizeT cnt = strlen(msg);
        IfxAsclin_Asc_write(&g_asc, (uint8_t*)msg, &cnt, TIME_INFINITE);
        const char *msg2 = "Board: TC397XX 292pin (ASCLIN0 P14.0 TX / P14.1 RX, 921600; RGMII YT8011AN)\r\n";
        cnt = strlen(msg2);
