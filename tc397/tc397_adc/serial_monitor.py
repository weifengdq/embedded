#!/usr/bin/env python3
"""Serial reader for TC397 UART0 (P14.0/P14.1, 921600) on Linux"""
import serial, time, sys, argparse

def main():
    parser = argparse.ArgumentParser(description="TC397 serial monitor")
    ...
    if total == 0:
        print("*** NO DATA ***")
        print("1) Check baud 921600, port is /dev/ttyACM0 (1a86:55d3) not /dev/ttyUSB0 (DAP)")
        print("2) Press RESET button on board")
        print("3) Check P14.0/P14.1 wiring")
