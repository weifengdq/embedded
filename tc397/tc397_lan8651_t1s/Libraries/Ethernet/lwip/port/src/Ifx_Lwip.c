...
/* NOTE (TC397 LAN8651): no GETH DMA ISRs here. LAN8651 is SPI-polled via
 * lan8651_ethernetif_input() from the main loop; QSPI4 TX/RX/ER ISRs live
 * in Cpu0_Main.c and forward to lan8651_qspi_*_isr(). */
