...
/* 通道数量宏（纯整数常量，供 IFX_INTERRUPT 优先级表达式使用，
 * 不能用 enum 成员 CAN_NUM，否则预处理期无法字符串化为中断向量符号名） */
#define CAN_CH_COUNT 8
...
CAN_TX_ISR(0, 0, CAN_PRIORITY + CAN_CH_COUNT + 0);
CAN_BUSOFF_ISR(0, 0, CAN_PRIORITY + 2 * CAN_CH_COUNT + 0);
CAN_RX_ISR(1, 0, CAN_PRIORITY + 1);
CAN_TX_ISR(1, 0, CAN_PRIORITY + CAN_CH_COUNT + 1);
CAN_BUSOFF_ISR(1, 0, CAN_PRIORITY + 2 * CAN_CH_COUNT + 1);
CAN_RX_ISR(2, 0, CAN_PRIORITY + 2);
CAN_TX_ISR(2, 0, CAN_PRIORITY + CAN_CH_COUNT + 2);
CAN_BUSOFF_ISR(2, 0, CAN_PRIORITY + 2 * CAN_CH_COUNT + 2);
CAN_RX_ISR(3, 0, CAN_PRIORITY + 3);
CAN_TX_ISR(3, 0, CAN_PRIORITY + CAN_CH_COUNT + 3);
CAN_BUSOFF_ISR(3, 0, CAN_PRIORITY + 2 * CAN_CH_COUNT + 3);
CAN_RX_ISR(4, 0, CAN_PRIORITY + 4);
CAN_TX_ISR(4, 0, CAN_PRIORITY + CAN_CH_COUNT + 4);
CAN_BUSOFF_ISR(4, 0, CAN_PRIORITY + 2 * CAN_CH_COUNT + 4);
CAN_RX_ISR(5, 0, CAN_PRIORITY + 5);
CAN_TX_ISR(5, 0, CAN_PRIORITY + CAN_CH_COUNT + 5);
CAN_BUSOFF_ISR(5, 0, CAN_PRIORITY + 2 * CAN_CH_COUNT + 5);
CAN_RX_ISR(6, 0, CAN_PRIORITY + 6);
CAN_TX_ISR(6, 0, CAN_PRIORITY + CAN_CH_COUNT + 6);
CAN_BUSOFF_ISR(6, 0, CAN_PRIORITY + 2 * CAN_CH_COUNT + 6);
CAN_RX_ISR(7, 0, CAN_PRIORITY + 7);
CAN_TX_ISR(7, 0, CAN_PRIORITY + CAN_CH_COUNT + 7);
CAN_BUSOFF_ISR(7, 0, CAN_PRIORITY + 2 * CAN_CH_COUNT + 7);
